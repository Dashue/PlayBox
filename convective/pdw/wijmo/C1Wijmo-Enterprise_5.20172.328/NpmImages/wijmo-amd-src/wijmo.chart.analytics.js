...
define(["require", "exports", "wijmo/wijmo.chart", "wijmo/wijmo", "wijmo/wijmo.chart.analytics"], function (require, exports, wjcChart, wjcCore, wjcSelf) {
    "use strict";
    ...
    var TrendLine = (function (_super) {
        ...
        TrendLine.prototype._calculateValues = function () {
            ...
            if (TrendLineHelper[fitType]) {
                var helper = new TrendLineHelper[fitType](this._originYValues, this._originXValues, this.sampleCount, this.order), vals = helper.calculateValues();
    ...
    var MaxXHelper = (function (_super) {
        ...
        MaxXHelper.prototype.calculateValues = function () {
            var xMax = this.xMax, yMin = MathHelper.min(this.y), yMax = MathHelper.max(this.y), valsX = [xMax, xMax], valsY = [yMin, yMax];
            this._setVal(xMax);
            return [valsY, valsX];
        };
    ...
    var MaxYHelper = (function (_super) {
        ...
        MaxYHelper.prototype.calculateValues = function () {
            var xMin = this.xMin, xMax = this.xMax, yMax = MathHelper.max(this.y), valsX = [xMin, xMax], valsY = [yMax, yMax];
            this._setVal(yMax);
            return [valsY, valsX];
        };
    ...
    var AverageXHelper = (function (_super) {
        ...
        AverageXHelper.prototype.calculateValues = function () {
            var xAverage = MathHelper.avg(this.x), yMin = MathHelper.min(this.y), yMax = MathHelper.max(this.y), valsX = [xAverage, xAverage], valsY = [yMin, yMax];
    ...
    var AverageYHelper = (function (_super) {
        ...
        AverageYHelper.prototype.calculateValues = function () {
            var yAverage = MathHelper.avg(this.y), xMin = this.xMin, xMax = this.xMax, valsX = [xMin, xMax], valsY = [yAverage, yAverage];
    ...
    var ErrorBar = (function (_super) {
        ...
        ErrorBar.prototype._rendering = function (sender, args) {
            ...
            this._plotter.plotSeries(engine, axisX, axisY, this, chart, args.index, args.count, function (points) {
                var paddings = _this._paddings, showPlus = _this._showPlus, showMinus = _this._showMinus, chartRotated = chart._isRotated(), off = (_this.errorBarStyle && _this.errorBarStyle['stroke-width']) || 2, offset, axis;
                if (chartRotated) {
                    axis = axisX;
                }
                else {
