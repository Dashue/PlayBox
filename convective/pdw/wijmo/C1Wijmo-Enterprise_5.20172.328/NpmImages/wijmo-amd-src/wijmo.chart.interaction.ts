...
import * as wjcSelf from 'wijmo/wijmo.chart.interaction';
...
/*
    ...
    */
    ...
    export class _RangeSlider {
        ...
        private _movingOffset: wjcCore.Rect = null;
        private _range: number = null;
        private _plotBox;
        private _startPt: wjcCore.Point = null;
        ...
        */
        rangeChanging = new wjcCore.Event();

        /**
         * Raises the @see:rangeChanging event.
         */
        onRangeChanging(e?: wjcCore.EventArgs) {
        ...
        private _onMove(mvPt: wjcCore.Point) {
            var self = this,
        ...
        private _onRangeSpaceMousedown(e) {
            var pt = e instanceof MouseEvent ?
                new wjcCore.Point(e.pageX, e.pageY) :
                new wjcCore.Point(e.changedTouches[0].pageX, e.changedTouches[0].pageY),
                sOffset = wjcCore.getElementRect(this._rsContent),
                rOffset = wjcCore.getElementRect(this._rangeHandler),
        ...
        _refresh(rsRect?) {
            var sliderOffset = 0, containerOffset = 0,
                ...
                rOffset = wjcCore.getElementRect(this._rsContainer);
        ...
        private _doSliding(offset, pt?: wjcCore.Point) {
            var sOffset = wjcCore.getElementRect(this._rsContent),
                rOffset = wjcCore.getElementRect(this._rangeHandler);
        ...
        private _setSlidingInterval(offset, pt?: wjcCore.Point) {
            var self = this,
                sOffset, rOffset;
 ...
 */
    ...
    */
    ...
    export class RangeSelector {
        ...
        private _chart: wjcChart.FlexChartCore;              // chart host
        ...
        private _refresh() {
            var chartHostEle = this._chart.hostElement,
                pa, pOffset, plotBox, rOffset = wjcCore.getElementRect(this._rangeSelectorEle);
        ...
        private _adjustMinAndMax() {
            var self = this, chart = self._chart, rangeSlider = self._rangeSlider,
                ...
                actualMin = wjcCore.isDate(axis.actualMin) ? axis.actualMin.valueOf() : axis.actualMin,
                actualMax = wjcCore.isDate(axis.actualMax) ? axis.actualMax.valueOf() : axis.actualMax,
    ...
    export class ChartGestures {
        ...
        private _startFirstPt: wjcCore.Point = null;
        ...
        private _endPoint: wjcCore.Point;
        ...
        private _pointerMove(e: any) {
            var pt1, pt2,
                mvPt = new wjcCore.Point(e.pageX, e.pageY),
        ...
        private _onTouchMove(e: any) {
            ...
            var scale = {}, offset = {},
                touchs = e.touches[0],
                mvPt = new wjcCore.Point(touchs.pageX, touchs.pageY),
                rNowCordinate, rStartCordinate,
        ...
        private _updateOverLay(mvPt: wjcCore.Point) {
        ...
        _updatePoint(mvPt: wjcCore.Point) {
        ...
        _pointInPlotArea(mvPt: wjcCore.Point) {
            var plotRect = this._plotOffset;
        ...
        private _zoomedChart(endPt: wjcCore.Point) {
            if (!endPt) {
                return;
            }
            //horizontal
        ...
        private _zoomedAxis(endPt: wjcCore.Point, isX: boolean) {
        ...
        private _updateAxisRange(axis: wjcChart.Axis, tMin: number, tMax: number) {
        ...
        private _getAxisMin(axis: wjcChart.Axis) {
            return wjcCore.isDate(axis.actualMin) ? axis.actualMin.valueOf() : axis.actualMin;
        }

        private _getAxisMax(axis: wjcChart.Axis) {
        ...
        private _disabledOthersInteraction(disabled: boolean) {
            ...
            for (var i = 0; i < lineMarks.length; i++) {
                if (disabled) {
                    wjcCore.addClass(<HTMLElement>lineMarks[i], ChartGestures._CSS_BLOCK_INTERACTION);
                } else {
                    wjcCore.removeClass(<HTMLElement>lineMarks[i], ChartGestures._CSS_BLOCK_INTERACTION);
                }
            }
        }

        private _getPoint(e: any): wjcCore.Point {
