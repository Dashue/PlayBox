...
define(["require", "exports", "wijmo/wijmo", "wijmo/wijmo.grid", "wijmo/wijmo.grid.grouppanel"], function (require, exports, wjcCore, wjcGrid, wjcSelf) {
    "use strict";
    ...
    var GroupPanel = (function (_super) {
        ...
        GroupPanel.prototype._removeGroup = function (index, groups) {
            ...
            var binding = groups[index].propertyName, col = this._g.columns.getColumn(binding);
