        ...
        (function (filter_1) {
            ...
            var ValueFilterEditor = (function (_super) {
                ...
                function ValueFilterEditor(element, filter) {
                    ...
                    // localization
                    _this._spSelectAll.textContent = wijmo.culture.FlexGridFilter.selectAll;
        ...
        (function (filter_1) {
            ...
            var ConditionFilterEditor = (function (_super) {
                ...
                function ConditionFilterEditor(element, filter) {
                    ...
                    // localization
                    _this._divHdr.textContent = wijmo.culture.FlexGridFilter.header;
                    _this._spAnd.textContent = wijmo.culture.FlexGridFilter.and;
                    _this._spOr.textContent = wijmo.culture.FlexGridFilter.or;
        ...
        (function (filter_1) {
            ...
            var ColumnFilterEditor = (function (_super) {
                ...
                function ColumnFilterEditor(element, filter, sortButtons) {
                    ...
                    // localization
                    _this._btnAsc.textContent = wijmo.culture.FlexGridFilter.ascending;
                    _this._btnDsc.textContent = wijmo.culture.FlexGridFilter.descending;
                    ...
                    _this._btnApply.textContent = wijmo.culture.FlexGridFilter.apply;
                    _this._btnClear.textContent = wijmo.culture.FlexGridFilter.clear;
            ...
            var FlexGridFilter = (function () {
                ...
                FlexGridFilter.prototype.editColumnFilter = function (col, ht) {
                    ...
                    edt.buttonClicked.addHandler(function () {
                        //this.closeEditor();
                        _this._g.focus(); // return focus to grid (will close editor)
