        ...
        var CubePivotField = (function (_super) {
            ...
            function CubePivotField(engine, binding, header, options) {
                ...
                if (_this.subFields != null && _this.subFields.length > 0) {
                    wijmo.assert(!hasBinding, 'Fields with sub-fields should not have bindings.');
                }
                else {
                    wijmo.assert(hasBinding, 'Fields without sub-fields should have bindings.');
                }
                return _this;
            }
        ...
        var PivotFieldEditor = (function (_super) {
            ...
            PivotFieldEditor.prototype._initAggregateOptions = function () {
                ...
                var g = wijmo.culture.olap.PivotFieldEditor.aggs, list = [
                    ...
                    { key: g.first, val: wijmo.Aggregate.First, all: true },
                    { key: g.last, val: wijmo.Aggregate.Last, all: true },
                ];
    ...
    (function (olap) {
        ...
        var PivotFilterEditor = (function (_super) {
            ...
            function PivotFilterEditor(element, field, options) {
                ...
                // localization
                _this._aVal.textContent = wijmo.culture.FlexGridFilter.values;
                _this._aCnd.textContent = wijmo.culture.FlexGridFilter.conditions;
                _this._btnOk.textContent = wijmo.culture.olap.PivotFieldEditor.ok;
        ...
        var PivotEngine = (function () {
                    ...
                    for (var key in item) {
                        if (wijmo.isPrimitive(item[key])) {
                            field = this._createField({
                                ...
                                dataType: wijmo.getType(item[key])
                            }, true);
                            this.fields.push(field);
                        }
                    }
            ...
            PivotEngine.prototype._createField = function (options, autoGenerated) {
                ...
                if (wijmo.isString(options)) {
                    field = new olap.PivotField(this, options);
                }
                else if (options.dimensionType != null) {
                    field = new olap.CubePivotField(this, options.binding, options.header, options);
                }
                else {
                    field = new olap.PivotField(this, options.binding, options.header, options);
                }
    ...
    (function (olap) {
        ...
        var _ServerConnection = (function () {
            ...
            _ServerConnection.prototype.getFields = function () {
                ...
                var xhr = wijmo.httpRequest(this._getUrl('Fields'), { async: false });
            ...
            _ServerConnection.prototype._loadArray = function (command, arr, data) {
                ...
                // make the request
                wijmo.httpRequest(this._getUrl(command), {
                    data: data,
            ...
            _ServerConnection.prototype._handleResult = function (result, callBack) {
                ...
                switch (result.executingStatus.toLowerCase()) {
                    ...
                    default:
                        wijmo.assert(false, 'Unexpected result...');
                        break;
                }
            };
    ...
    (function (olap) {
        ...
        var _ListContextMenu = (function (_super) {
            ...
            _ListContextMenu.prototype._canExecute = function (parm) {
                var grid = wijmo.Control.getControl(this.owner), row = grid.selection.row, fld = grid.rows[row].dataItem, ng = fld ? fld.engine : null, target = this._getTargetList(ng, parm);
    ...
    (function (olap) {
        ...
        var PivotPanel = (function (_super) {
            ...
            PivotPanel.prototype._drop = function (e) {
                ...
                var target = this._getFlexGridTarget(e);
                if (target && this._dragField) {
                    var source = wijmo.Control.getControl(this._dragSource), fld = this._dragField;
    ...
    (function (olap) {
        ...
        var _GridContextMenu = (function (_super) {
            ...
            _GridContextMenu.prototype._canExecute = function (parm) {
                var g = wijmo.Control.getControl(this.owner), ng = g.engine, fld = this._targetField;
                // check whether the command can be executed in the current context
                switch (parm) {
                    case 'remove':
                        return fld != null;
