            ...
            */
            ...
            TreeView.prototype._mousedown = function (e) {
                if (!e.defaultPrevented) {
                    var cb = wijmo.closest(e.target, 'input.' + TreeView._CNDC), ne = wijmo.closest(e.target, '.' + TreeView._CND), node = ne ? new nav.TreeNode(this, ne) : null;
                    // select clicked item
                    if (node && !node.isDisabled) {
            ...
            TreeView.prototype._click = function (e) {
                var _this = this;
                if (!e.defaultPrevented) {
                    var nodeElement = wijmo.closest(e.target, '.' + TreeView._CND);
                    if (nodeElement) {
                        var node = new nav.TreeNode(this, nodeElement), cb = wijmo.closest(e.target, 'input.' + TreeView._CNDC);
    ...
    (function (nav) {
        ...
        var TreeNode = (function () {
            ...
            Object.defineProperty(TreeNode.prototype, "isCollapsed", {
                ...
                set: function (value) {
                    if (value != this.isCollapsed) {
                        var tree = this.treeView, e = new nav.TreeNodeEventArgs(this);
            ...
            TreeNode.prototype.setCollapsed = function (collapsed, animate, collapseSiblings) {
                ...
                // handle lazy-loading
                if (!collapsed && !hasList && wijmo.isFunction(this._t.lazyLoadFunction)) {
            ...
            TreeNode.prototype._moveElements = function (refNode, position) {
                ...
                var ref = refNode.element, parent = ref ? ref.parentElement : refNode.treeView._root, dp = nav.DropPosition;
                // sanity
        ...
        var _TreeDragDropManager = (function () {
            ...
            _TreeDragDropManager.prototype._dragstart = function (e) {
                if (!e.defaultPrevented) {
                    ...
                    var tree = this._tree, target = wijmo.closest(e.target, '.' + nav.TreeView._CND);
            ...
            _TreeDragDropManager.prototype._handleDragDrop = function (e, drop) {
                ...
                if (!e.defaultPrevented && ddm._drgSrc) {
                    // get target node
                    var element = document.elementFromPoint(e.clientX, e.clientY), target = wijmo.closest(element, '.' + nav.TreeView._CND);
                    ...
                    if (target) {
                        ...
                        var tree = this._tree, targetNode = new nav.TreeNode(tree, target), dp = nav.DropPosition, pos = dp.Into, rc = target.getBoundingClientRect(), szCheck = targetNode.hasPendingChildren ? rc.height / 2 : rc.height / 3;
            ...
            _TreeDragDropManager.prototype._showDragMarker = function (rc, pos) {
                ...
                if (rc) {
                    ...
                    var rcHost = tree.hostElement.getBoundingClientRect(), top = pos == nav.DropPosition.After ? rc.bottom : rc.top;
                    var css = {
