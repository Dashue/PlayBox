...
module wijmo.viewer {
    ...
    export function _pointMove(positive: boolean, pos: Point, detalPosOrX: Point | number, y?: number): Point {
        var x: number, factor = positive ? 1 : -1;
        if (detalPosOrX instanceof Point) {
            x = detalPosOrX.x;
            y = detalPosOrX.y;
        } else {
            x = detalPosOrX;
        ...
        return new Point(pos.x + factor * x, pos.y + factor * y);
    }
    ...
    export function _getTransformedPosition(bound: _IRect, size: _ISize, rotateAngle: _RotateAngle, zoomFactor: number): Point {
        var boundsPx = {
        ...
        return new Point(widthOffset * zoomFactor, heightOffset * zoomFactor);
    }
...
module wijmo.viewer {
    ...
    export class _DocumentSource {
        ...
        private _removeScript(doc: PrintDocument) {
...
module wijmo.viewer {
    ...
    export class _SearchManager {
        ...
        private _onSearchCompleted() {
            this.searchCompleted.raise(this, new EventArgs());
        }
...
module wijmo.viewer {
    ...
    export class _TouchInfo {
        ...
        static getCenterClient(startInfo: _TouchInfo, endInfo: _TouchInfo): Point {
            return _TouchInfo.getCenter(new Point(startInfo.clientX, startInfo.clientY), new Point(endInfo.clientX, endInfo.clientY));
        }

        static getCenterScreen(startInfo: _TouchInfo, endInfo: _TouchInfo): Point {
            return _TouchInfo.getCenter(new Point(startInfo.screenX, startInfo.screenY), new Point(endInfo.screenX, endInfo.screenY));
        }
...
module wijmo.viewer {
    ...
    export class _TouchEventArgs extends EventArgs {
    ...
    export class _TouchEvent extends Event {
...
module wijmo.viewer {
    export class _PanEventArgs extends _TouchEventArgs {
        ...
        private _screen: Point;
        private _clientDelta: Point;
        private _screenDelta: Point;

        constructor(args: _TouchEventArgs, pre?: _PanEventArgs, type?: _TouchEventType) {
            super(args);
            this._panType = type == null ? args.type : type;
            this._client = new Point(this.touchInfo.clientX, this.touchInfo.clientY);
            this._screen = new Point(this.touchInfo.screenX, this.touchInfo.screenY);
            if (pre) {
                this._clientDelta = new Point(this.client.x - pre.client.x, this.client.y - pre.client.y);
                this._screenDelta = new Point(this.screen.x - pre.screen.x, this.screen.y - pre.screen.y);
            }
        }
        ...
        get clientDelta(): Point {
            return this._clientDelta;
        }

        get screenDelta(): Point {
...
module wijmo.viewer {
    export class _SwipeEventArgs extends _PanEventArgs {
        ...
        constructor(startInfo: _TouchInfo, endInfo: _TouchInfo, panEventArgs: _PanEventArgs, duration: number) {
            ...
            var distance = _pointMove(false, new Point(this.endTouchInfo.clientX, this.endTouchInfo.clientY), new Point(this.startTouchInfo.clientX, this.startTouchInfo.clientY));
            this._speed = new Point(_SwipeTrigger.getSpeed(distance.x, this.duration), _SwipeTrigger.getSpeed(distance.y, this.duration));
...
module wijmo.viewer {
    ...
    export class _PinchEventArgs extends _TouchEventArgs {
        ...
        private _centerClient: Point;
        private _centerClientDelta: Point;
        private _centerScreen: Point;
        private _centerScreenDelta: Point;
        ...
        constructor(touchEventArgs: _TouchEventArgs, pinchType: _TouchEventType, pre?: _PinchEventArgs) {
            ...
            this._centerClientDelta = new Point((this.centerClient.x - this.preCenterClient.x),
                (this.centerClient.y - this.preCenterClient.y));
            this._centerScreenDelta = new Point((this.centerScreen.x - this.preCenterScreen.x),
        ...
        get centerScreenDelta(): Point {
            return this._centerScreenDelta;
        }

        get centerClientDelta(): Point {
            return this._centerClientDelta;
        }

        get centerClient(): Point {
            return this._centerClient;
        }

        get preCenterClient(): Point {
            return this._pre.centerClient;
        }

        get centerScreen(): Point {
            return this._centerScreen;
        }

        get preCenterScreen(): Point {
...
module wijmo.viewer {
    ...
    export class _PageSetupEditor extends Control {
    ...
    export class _ExportOptionEditor extends Control {
        ...
        constructor(element: any) {
            ...
            addClass(element, 'wj-export-editor');
        }
        ...
        private _generateBoolEditor(desc: _IExportOptionDescription): HTMLElement {
            ...
            if (desc.nullable) {
                ...
                var checkEditor = new input.ComboBox(element), itemsSource: Object[] = [];
                ...
                var defaultValue = changeType(desc.defaultValue, DataType.Boolean, null);
        ...
        private _generateGroup(optionDescs: _IExportOptionDescription[]): HTMLElement {
            ...
            addClass(fieldSet, 'wj-exportformats-group');
        ...
        private _updateEditors(optionName?: string) {
            if (optionName === 'pdfACompatible' || !optionName) {
                ...
                if (embedFonts) {
                    var pdfACompatibleValue = changeType(this._getOptionValue('pdfACompatible'), DataType.Boolean, null);
            ...
            if (optionName === 'paged' || !optionName) {
                ...
                if (showNavigator) {
                    var paged = changeType(this._getOptionValue('paged'), DataType.Boolean, null);
                    if (!paged) {
...
module wijmo.viewer {
    ...
    export class _Toolbar extends Control {
        ...
        private _checkMoveButtonEnabled() {
            var leftBtnWidth = this._toolbarLeft.getBoundingClientRect().width,
                ...
                leftBtnHasEnableClass = hasClass(this._toolbarLeft, _Toolbar._enabledCss);
            if (leftBtnEnabled) {
                if (!leftBtnHasEnableClass) {
                    addClass(this._toolbarLeft, _Toolbar._enabledCss);
                }
            } else {
                if (leftBtnHasEnableClass) {
                    removeClass(this._toolbarLeft, _Toolbar._enabledCss);
                }
            }
            ...
            var rightBtnWidth = this._toolbarRight.getBoundingClientRect().width,
                ...
                rightBtnHasEnabledClass = hasClass(this._toolbarRight, _Toolbar._enabledCss);
            if (rightBtnEnabled) {
                if (!rightBtnHasEnabledClass) {
                    addClass(this._toolbarRight, _Toolbar._enabledCss);
                }
            } else if (rightBtnHasEnabledClass) {
                removeClass(this._toolbarRight, _Toolbar._enabledCss);
            }
        }
    ...
    export class _ViewerToolbar extends _ViewerToolbarBase {
        ...
        _initToolbarItems() {
            this._gPaginated = this.addSvgButton(wijmo.culture.Viewer.paginated, icons.paginated, _ViewerActionType.TogglePaginated, true);
            this._gPrint = this.addSvgButton(wijmo.culture.Viewer.print, icons.print, _ViewerActionType.Print);
            this._gExports = this.addSvgButton(wijmo.culture.Viewer.exports, icons.exports, _ViewerActionType.ShowExportsPanel);
            this.addSeparator();
            this._gPortrait = this.addSvgButton(wijmo.culture.Viewer.portrait, icons.portrait, _ViewerActionType.Portrait);
            this._gLandscape = this.addSvgButton(wijmo.culture.Viewer.landscape, icons.landscape, _ViewerActionType.Landscape);
            this._gPageSetup = this.addSvgButton(wijmo.culture.Viewer.pageSetup, icons.pageSetup, _ViewerActionType.ShowPageSetupDialog);
            this.addSeparator();
            this._gFirstPage = this.addSvgButton(wijmo.culture.Viewer.firstPage, icons.firstPage, _ViewerActionType.FirstPage);
            this._gPreviousPage = this.addSvgButton(wijmo.culture.Viewer.previousPage, icons.previousPage, _ViewerActionType.PrePage);
            this._gNextPage = this.addSvgButton(wijmo.culture.Viewer.nextPage, icons.nextPage, _ViewerActionType.NextPage);
            this._gLastPage = this.addSvgButton(wijmo.culture.Viewer.lastPage, icons.lastPage, _ViewerActionType.LastPage);
            _ViewerToolbarBase._initToolbarPageNumberInput(this.hostElement, this.viewer);
            this.addSeparator();
            this._gBackwardHistory = this.addSvgButton(wijmo.culture.Viewer.backwardHistory, icons.backwardHistory, _ViewerActionType.Backward);
            this._gForwardHistory = this.addSvgButton(wijmo.culture.Viewer.forwardHistory, icons.forwardHistory, _ViewerActionType.Forward);
            this.addSeparator();
            this._gSelectTool = this.addSvgButton(wijmo.culture.Viewer.selectTool, icons.selectTool, _ViewerActionType.SelectTool);
            this._gMoveTool = this.addSvgButton(wijmo.culture.Viewer.moveTool, icons.moveTool, _ViewerActionType.MoveTool);
            this._gContinuousMode = this.addSvgButton(wijmo.culture.Viewer.continuousMode, icons.continuousView, _ViewerActionType.Continuous);
            this._gSingleMode = this.addSvgButton(wijmo.culture.Viewer.singleMode, icons.singleView, _ViewerActionType.Single);
            this.addSeparator();
            this._gWholePage = this.addSvgButton(wijmo.culture.Viewer.wholePage, icons.fitWholePage, _ViewerActionType.FitWholePage);
            this._gPageWidth = this.addSvgButton(wijmo.culture.Viewer.pageWidth, icons.fitPageWidth, _ViewerActionType.FitPageWidth);
            this._gZoomOut = this.addSvgButton(wijmo.culture.Viewer.zoomOut, icons.zoomOut, _ViewerActionType.ZoomOut);
            this._gZoomIn = this.addSvgButton(wijmo.culture.Viewer.zoomIn, icons.zoomIn, _ViewerActionType.ZoomIn);
            //todo change rubberband icon.
            this._gRubberbandTool = this.addSvgButton(wijmo.culture.Viewer.rubberbandTool, icons.rubberbandTool, _ViewerActionType.RubberbandTool);
            this._gMagnifierTool = this.addSvgButton(wijmo.culture.Viewer.magnifierTool, icons.magnifierTool, _ViewerActionType.MagnifierTool);
            this._gRotateDocument = this.addSvgButton(wijmo.culture.Viewer.rotateDocument, icons.rotateDocument, _ViewerActionType.RotateDocument);
            this._gRotatePage = this.addSvgButton(wijmo.culture.Viewer.rotatePage, icons.rotatePage, _ViewerActionType.RotatePage);
            _ViewerToolbarBase._initToolbarZoomValue(this.hostElement, this.viewer);
            this._gFullScreen = this.addSvgButton(wijmo.culture.Viewer.fullScreen, icons.fullScreen, _ViewerActionType.ToggleFullScreen, true);
        }
    }
    ...
    export class _ViewerMiniToolbar extends _ViewerToolbarBase {
        ...
        _initToolbarItems() {
            ...
            this._gZoomOut = this.addSvgButton(wijmo.culture.Viewer.zoomOut, icons.zoomOut, _ViewerActionType.ZoomOut);
            this._gZoomIn = this.addSvgButton(wijmo.culture.Viewer.zoomIn, icons.zoomIn, _ViewerActionType.ZoomIn);
            this._gExitFullScreen = this.addSvgButton(wijmo.culture.Viewer.exitFullScreen, icons.exitFullScreen, _ViewerActionType.ToggleFullScreen, true);
        }
    ...
    export class _ViewerMobileToolbarBase extends _ViewerToolbarBase {
        constructor(element: any, viewer: ViewerBase) {
            ...
            addClass(this.hostElement, 'mobile');
        }
    }
    ...
    export class _ViewerMobileToolbar extends _ViewerMobileToolbarBase {
        ...
        _initToolbarItems() {
            this._gShowHamburgerMenu = this.addSvgButton(wijmo.culture.Viewer.hamburgerMenu, icons.hamburgerMenu, _ViewerActionType.ShowHamburgerMenu);
            this.viewer._initHamburgerMenu(this._gShowHamburgerMenu);
            this._gPrevPage = this.addSvgButton(wijmo.culture.Viewer.previousPage, icons.previousPage, _ViewerActionType.PrePage);
            this._gNextPage = this.addSvgButton(wijmo.culture.Viewer.nextPage, icons.nextPage, _ViewerActionType.NextPage);
            _ViewerToolbarBase._initToolbarPageNumberInput(this.hostElement, this.viewer);
            this._gShowViewMenu = this.addSvgButton(wijmo.culture.Viewer.viewMenu, icons.viewMenu, _ViewerActionType.ShowViewMenu);
            this.viewer._initViewMenu(this._gShowViewMenu);
            this._gShowSearchBar = this.addSvgButton(wijmo.culture.Viewer.showSearchBar, icons.search, _ViewerActionType.ShowSearchBar, true);
            this._gFullScreen = this.addSvgButton(wijmo.culture.Viewer.fullScreen, icons.fullScreen, _ViewerActionType.ToggleFullScreen, true);
        }
    ...
    export class _ViewerZoomBar extends _ViewerMobileToolbarBase {
        ...
        constructor(element: any, viewer: ViewerBase) {
            ...
            addClass(this.hostElement, 'wj-zoombar');
        }
    ...
    export class _SearchBar extends _ViewerMobileToolbarBase {
        ...
        _initToolbarItems() {
            this._gSearchOptions = this.addSvgButton(wijmo.culture.Viewer.searchOptions, icons.searchOptions, _ViewerActionType.ShowSearchOptions);
        ...
        private _initSearchBtnGroups() {
            ...
            this._gSearchPrev = this.addSvgButton(wijmo.culture.Viewer.searchPrev, icons.searchLeft, _ViewerActionType.SearchPrev);
            this._gSearchNext = this.addSvgButton(wijmo.culture.Viewer.searchNext, icons.searchRight, _ViewerActionType.SearchNext);
...
module wijmo.viewer {
    ...
    export class _CompositePageView extends Control implements _IPageView {
        ...
        zoomModeChanged = new Event();

        positionChanged = new Event();

        rotateAngleChanged = new Event();
        ...
        private _updatePageViewsVisible(): void {
            ...
            if (showSingle) {
                removeClass(this._singlePageView, _hiddenCss);
                if (!hasClass(this._continuousPageView, _hiddenCss)) {
                    addClass(this._continuousPageView, _hiddenCss);
                }
            } else {
                removeClass(this._continuousPageView, _hiddenCss);
                if (!hasClass(this._singlePageView, _hiddenCss)) {
                    addClass(this._singlePageView, _hiddenCss);
                }
            }
        }
    ...
    export class _PageViewBase extends Control implements _IPageView {
        ...
        private _zoomByPinch(touchManager: _TouchManager, args: _PinchEventArgs) {
            ...
            var contentRect = getElementRect(touchManager.contentElement),
        ...
        private _getFixedPosition(position: Point): Point {
            return new Point(_PageViewBase._pageMargin, _PageViewBase._pageMargin + this._getAbovePageCount(position.y) * _PageViewBase._pageMargin);
        }
        ...
        private _zoom(container: Element, value: number, center: Point, delta: Point) {
            ...
            var newCenter = new Point((center.x - fixedPos.x) * zoom + fixedPos.x, (center.y - fixedPos.y) * zoom + fixedPos.y),
    ...
    export class _Scroller extends Control {
    ...
    export class _SinglePageView extends _PageViewBase {
        ...
        constructor(element: any) {
            super(element);
            addClass(element, "wj-pageview-single");
        }
        ...
        refresh(fullUpdate = true) {
            ...
            if (this._isScrollerVisible) {
                addClass(this.hostElement, "virtual");
            } else {
    ...
    export class _ContinuousPageView extends _PageViewBase {
        ...
        constructor(element: any) {
            super(element);
            addClass(element, "wj-pageview-continuous");
        }
...
module wijmo.viewer {
    ...
    export class _SideTabs extends Control {
        ...
        hide(page: string | _TabPage): void {
            ...
            if (hasClass(tabPage.header, _hiddenCss)) {
                return;
            }

            addClass(tabPage.header, _hiddenCss);
        ...
        show(page: string | _TabPage): void {
            ...
            removeClass(tabPage.header, _hiddenCss);
            this.onTabPageVisibilityChanged(tabPage);
    ...
    export class _TabPage {
        ...
        get isHidden(): boolean {
            return hasClass(this.header, _hiddenCss);
        }
...
module wijmo.viewer {
    ...
    export class _ViewerMenuBase extends wijmo.input.Menu {
        ...
        private _onItemClicked(menu: input.Menu): void {
        ...
        showMenu(above?: boolean) {
            ...
            showPopup(this.dropDown, this.owner, above, false, false);
            this.dropDown.style.color = this._viewer.hostElement.style.color;
            addClass(this.dropDown, 'wj-btn-group-vertical');
            addClass(this.dropDown, 'wj-viewer-menu');
    ...
    export class _HamburgerMenu extends _ViewerMenuBase {
        ...
        _initItems(): any[] {
            var items = [];
            items.push({ title: wijmo.culture.Viewer.thumbnails, icon: icons.thumbnails, commandTag: _ViewerActionType.ShowThumbnails });
            items.push({ title: wijmo.culture.Viewer.outlines, icon: icons.outlines, commandTag: _ViewerActionType.ShowOutlines });
            items.push({ title: wijmo.culture.Viewer.exports, icon: icons.exports, commandTag: _ViewerActionType.ShowExportsPanel });
            items.push({ title: ViewerBase._seperatorHtml });
            items.push({ title: wijmo.culture.Viewer.portrait, icon: icons.portrait, commandTag: _ViewerActionType.Portrait });
            items.push({ title: wijmo.culture.Viewer.landscape, icon: icons.landscape, commandTag: _ViewerActionType.Landscape });
            items.push({ title: wijmo.culture.Viewer.pageSetup, icon: icons.pageSetup, commandTag: _ViewerActionType.ShowPageSetupPanel });
            items.push({ title: ViewerBase._seperatorHtml });
            items.push({ title: wijmo.culture.Viewer.showZoomBar, icon: icons.showZoomBar, commandTag: _ViewerActionType.ShowZoomBar });
            items.push({ title: ViewerBase._seperatorHtml });
            items.push({ title: wijmo.culture.Viewer.paginated, icon: icons.paginated, commandTag: _ViewerActionType.TogglePaginated });
            items.push({ title: wijmo.culture.Viewer.print, icon: icons.print, commandTag: _ViewerActionType.Print });
            items.push({ title: ViewerBase._seperatorHtml });
            items.push({ title: wijmo.culture.Viewer.backwardHistory, icon: icons.backwardHistory, commandTag: _ViewerActionType.Backward });
            items.push({ title: wijmo.culture.Viewer.forwardHistory, icon: icons.forwardHistory, commandTag: _ViewerActionType.Forward });
    ...
    export class _SearchOptionsMenu extends _ViewerMenuBase {
        ...
        _updateActionStatus(actionElement: HTMLElement, actionType: _ViewerActionType) {
            ...
            if (this.viewer._actionIsChecked(actionType)) {
                addClass(actionElement, 'checked');
            }
        }
    }
}
...
module wijmo.viewer {
    ...
    */
    ...
    export class _LinkClickedEventArgs extends EventArgs {
    ...
    export class ViewerBase extends Control {
        ...
        private _switchTemplate(mobile: boolean) {
            ...
            if (mobile) {
                addClass(outer, mobileCss);
                sideTabs.show(pageSetupPage);
            } else {
                removeClass(outer, mobileCss);
        ...
        private _showSearchBar(show: boolean) {
            ...
            if (show) {
                removeClass(this._searchBar, _hiddenCss);
                addClass(outer, withSearchBarCss);
            } else {
                addClass(this._searchBar, _hiddenCss);
                removeClass(outer, withSearchBarCss);
            }
        }
        ...
        private _showFooter(show: boolean) {
            ...
            if (show) {
                removeClass(this._footer, _hiddenCss);
                addClass(outer, withFooterCss);
            } else {
                addClass(this._footer, _hiddenCss);
                removeClass(outer, withFooterCss);
            }
        }
        ...
        private _resetViewPanelContainerWidth() {
            if (!this._isMobileTemplate() && this.hostElement.getBoundingClientRect().width <= ViewerBase._narrowWidthThreshold) {
                addClass(this.hostElement, ViewerBase._narrowCss);
            } else {
                removeClass(this.hostElement, ViewerBase._narrowCss);
            }
        ...
        private _initSidePanelThumbnails() {
            ...
            thumbnailsPage.format(t => {
                ...
                list.formatItem.addHandler((sender, e: wijmo.input.FormatItemEventArgs) => {
                    ...
                    addClass(svgContainer, 'wj-pagethumbnail');
        ...
        private _initSidePanelExports() {
            ...
            exportsPage.format(t => {
                ...
                addClass(t.content.parentElement, 'wj-exportformats-wrapper');
        ...
        private _initSidePanelPageSetup() {
            ...
            pageSetupPage.format(t => {
                ...
                addClass(editorElement, 'wj-pagesetupcontainer');
        ...
        _executeAction(action: _ViewerActionType) {
            ...
            switch (action) {
                ...
                case _ViewerActionType.ShowSearchBar:
                    this._showSearchBar(hasClass(this._searchBar, _hiddenCss));
        ...
        _actionIsChecked(action: _ViewerActionType): boolean {
            switch (action) {
                ...
                case _ViewerActionType.ShowSearchBar:
                    return !hasClass(this._searchBar, _hiddenCss);
            }
            return false;
        }
         ...
         */
        zoomToView() {
            _deprecated('zoomToView', 'zoomMode');
         ...
         */
        zoomToViewWidth() {
            _deprecated('zoomToViewWidth', 'zoomMode');
            var doc = this._documentSource;
            if (!doc) {
                return;
            }
        ...
        */
        ...
        set selectMouseMode(value: boolean) {
            _deprecated('selectMouseMode', 'mouseMode');
        ...
        */
		...
		set mouseMode(value: MouseMode) {
			if (this._mouseMode === (value = asEnum(value, MouseMode))) {
                return;
            }
        ...
        */
         ...
         */
        onPageIndexChanged(e?: EventArgs) {
            this.pageIndexChanged.raise(this, e || new EventArgs());
            this._updatePageNavActions();
        }
        ...
        onSelectMouseModeChanged(e?: EventArgs) {
            if (this.selectMouseModeChanged.hasHandlers) {
                _deprecated('selectMouseModeChanged', 'mouseModeChanged');
            }
         ...
         * @param e The @see:EventArgs object.
         */
        onMouseModeChanged(e?: EventArgs) {
            this.mouseModeChanged.raise(this, e || new EventArgs());
    ...
    export class _Rubberband extends Control {
        ...
        constructor(element: any, viewPanelContainer: HTMLElement, pageView: _IPageView) {
            ...
            addClass(this.hostElement, _Rubberband._rubberbandCss);
            this._bindEvents();
        }
        ...
        active() {
            this._actived = true;
            addClass(this._viewPanelContainer, _Rubberband._rubberbandActivedCss);
        }
        ...
        deactive() {
            ...
            this._actived = false;
            removeClass(this._viewPanelContainer, _Rubberband._rubberbandActivedCss);
        }
        ...
        private _start(e: MouseEvent) {
            ...
            addClass(this.hostElement, _Rubberband._rubberbandShowCss);
        }
        ...
        private _stop() {
            ...
            removeClass(this.hostElement, _Rubberband._rubberbandShowCss);
        }
    ...
    export class _Magnifier extends Control {
        private _pageView: _IPageView;
        private _viewPanelContainer: HTMLElement;
        ...
        private _initElement() {
            addClass(this.hostElement, 'wj-magnifier');
        ...
        private _show(e: MouseEvent, start: boolean) {
            ...
            if (start) {
                addClass(this.hostElement, _Magnifier._magnifierShowCss);
            }
            var magnifierRect = this.hostElement.getBoundingClientRect();
        ...
        private _hide() {
            removeClass(this.hostElement, _Magnifier._magnifierShowCss);
        }

        active() {
            this._actived = true;
            addClass(this._viewPanelContainer, _Magnifier._magnifierActivedCss);
        }
        ...
        deactive() {
            ...
            removeClass(this._viewPanelContainer, _Magnifier._magnifierActivedCss);
        }
    }
}
module wijmo.viewer {
