        ...
        var Axis = (function () {
                ...
                if (isVert) {
                    ...
                    if (isNear) {
                        ...
                        if (showLabel) {
                            ...
                            if (labelAngle > 0) {
                                if (labelAngle == 90) {
                                    chart_1.FlexChart._renderRotatedText(engine, sval, lpt, 1, 0, lpt, labelAngle, lblClass, this._groupClass);
                                }
                                else {
                                    chart_1.FlexChart._renderRotatedText(engine, sval, lpt, 2, 1, lpt, labelAngle, lblClass, this._groupClass);
                                }
                            }
                            else if (labelAngle < 0) {
                                if (labelAngle == -90) {
                                    chart_1.FlexChart._renderRotatedText(engine, sval, lpt, 1, 2, lpt, labelAngle, lblClass, this._groupClass);
                                }
                                else {
                                    chart_1.FlexChart._renderRotatedText(engine, sval, lpt, 2, 1, lpt, labelAngle, lblClass, this._groupClass);
                                }
                        ...
                        if (showLabel) {
                            ...
                            if (labelAngle > 0) {
                                if (labelAngle == 90) {
                                    ...
                                    chart_1.FlexChart._renderRotatedText(engine, sval, lpt, 0, 1, lpt, labelAngle, lblClass, this._groupClass);
                                }
                            }
                            else if (labelAngle < 0) {
                                if (labelAngle == -90) {
            ...
            Axis.prototype._renderRotatedLabel = function (engine, sval, lpt, labelAngle, lblClass, isNear) {
                if (sval) {
                    ...
                    chart_1.FlexChart._renderRotatedText(engine, sval, lpt, ha, 1, lpt, labelAngle, lblClass, this._groupClass);
