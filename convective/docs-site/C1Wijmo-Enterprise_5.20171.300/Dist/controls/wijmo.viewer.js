    ...
    (function (viewer) {
        ...
        var _PageViewBase = (function (_super) {
            ...
            _PageViewBase.prototype._hitTestPagePosition = function (top, left) {
                ...
                var pageY = viewer._pixelToTwip(top), pageX = viewer._pixelToTwip(left), size = this.pages[this.pageIndex].size, hitPageView = top >= 0 && top <= size.height.valueInPixel &&
        ...
        var _ContinuousPageView = (function (_super) {
            ...
            _ContinuousPageView.prototype._moveToPagePosition = function (position) {
                this._stopSwip();
                var pageHeight, scrollTop = 0, scrollLeft = 0, bound = position.pageBounds || { x: 0, y: 0, width: 0, height: 0 }, 
                //no pageBounds means navigate to page, should scroll to the top of page container.
                margin = position.pageBounds ? _PageViewBase._pageMargin : 0, currentPage = this.pages[this.pageIndex];
                ...
                var offsetPoint = viewer._getTransformedPosition(bound, currentPage.size, currentPage.rotateAngle, this.zoomFactor);
        ...
        */
        ...
        var ViewerBase = (function (_super) {
            ...
            ViewerBase.prototype._initSidePanelThumbnails = function () {
                ...
                thumbnailsPage.format(function (t) {
                    ...
                    list.formatItem.addHandler(function (sender, e) {
                        var item = e.item, data = e.data, svgContainer = document.createElement('div'), svg = viewer._toDOM(svgStart + '</svg>'), g = document.createElementNS('http://www.w3.org/2000/svg', 'g'), img = document.createElementNS('http://www.w3.org/2000/svg', 'image'), indexDiv = document.createElement('div'), page = _this._pageView.pages[e.index], width = page.size.width.valueInPixel, height = page.size.height.valueInPixel, thumbnailHeight = height * ViewerBase._thumbnailWidth / width;
                        item.innerHTML = '';
                    ...
                    _this._pageView.rotateAngleChanged.addHandler(function () {
                        ...
                        for (var i = 0; i < svgs.length; i++) {
                            ...
                            viewer._transformSvg(current, thumbWidth, thumbHeight, 1, page.rotateAngle);
            ...
            ViewerBase.prototype._updateExportFormats = function (refresh) {
                ...
                this._supportedFormats.forEach(function (item) {
                    ...
                    if (viewer._DocumentSource._isIOS() && !itemDescription.supportIOS) {
                        return;
                    }
            ...
            ViewerBase.prototype._actionIsShown = function (action) {
                ...
                switch (action) {
                    ...
                    case _ViewerActionType.SelectTool:
                    case _ViewerActionType.MoveTool:
                        return !viewer._DocumentSource._isMobile();
                    case _ViewerActionType.ShowSearchBar:
            ...
            ViewerBase.prototype._export = function (options) {
                ...
                if (viewer._DocumentSource._isIOS()) {
            ...
            ViewerBase.prototype.onMouseModeChanged = function (e) {
                ...
                if ((this.mouseMode === MouseMode.MoveTool || this.mouseMode === MouseMode.SelectTool) &&
                    viewer._DocumentSource._isMobile()) {
                    return;
                }
                this._updateMouseModeActions();
        ...
        var _Rubberband = (function (_super) {
            ...
            function _Rubberband(element, viewPanelContainer, pageView) {
                ...
                wijmo.addClass(_this.hostElement, _Rubberband._rubberbandCss);
                _this._bindEvents();
                return _this;
            }
            ...
            _Rubberband.prototype.active = function () {
                this._actived = true;
                wijmo.addClass(this._viewPanelContainer, _Rubberband._rubberbandActivedCss);
            };
            _Rubberband.prototype.deactive = function () {
                ...
                this._actived = false;
                wijmo.removeClass(this._viewPanelContainer, _Rubberband._rubberbandActivedCss);
            };
            _Rubberband.prototype._start = function (e) {
                ...
                wijmo.addClass(this.hostElement, _Rubberband._rubberbandShowCss);
            };
            ...
            _Rubberband.prototype._stop = function () {
                ...
                wijmo.removeClass(this.hostElement, _Rubberband._rubberbandShowCss);
            };
            ...
            _Rubberband.prototype._zoom = function () {
                ...
                var position = viewer._getPositionByHitTestInfo(this._pageView.hitTest(this._startX, this._startY));
        ...
        var _Magnifier = (function (_super) {
            ...
            _Magnifier.prototype._initElement = function () {
                wijmo.addClass(this.hostElement, 'wj-magnifier');
                this._viewPageDiv = viewer._toDOM(_Magnifier._viewPageTemplate);
            ...
            _Magnifier.prototype._bindEvents = function () {
                ...
                var updateViewPage = function () {
                    ...
                    var currentPage = _this._pageView.pages[_this._currentPageIndex], rotatedSize = viewer._getRotatedSize(currentPage.size, currentPage.rotateAngle), svg = _this._viewPageDiv.querySelector('svg');
                    ...
                    viewer._transformSvg(svg, currentPage.size.width.valueInPixel, currentPage.size.height.valueInPixel, _Magnifier._magnification * _this._pageView.zoomFactor, currentPage.rotateAngle);
                };
            ...
            _Magnifier.prototype._fillPage = function (hitPosition) {
                ...
                this._pageView.pages[this._currentPageIndex].getContent().then(function (pageContent) {
                    ...
                    clone.setAttribute('width', new viewer._Unit(clone.getAttribute('width')).valueInPixel * _Magnifier._magnification + 'px');
                    clone.setAttribute('height', new viewer._Unit(clone.getAttribute('height')).valueInPixel * _Magnifier._magnification + 'px');
                    var size = _this._pageView.pages[_this._currentPageIndex].size;
                    viewer._transformSvg(clone, size.width.valueInPixel, size.height.valueInPixel, _Magnifier._magnification * _this._pageView.zoomFactor, _this._pageView.pages[_this._currentPageIndex].rotateAngle);
            ...
            _Magnifier.prototype._showHitPosition = function (hitPosition) {
                var magnifierRect = this.hostElement.getBoundingClientRect(), currentPage = this._pageView.pages[this._currentPageIndex], transformedBound = viewer._getTransformedPosition(hitPosition.pageBounds, currentPage.size, currentPage.rotateAngle, this._pageView.zoomFactor);
            ...
            _Magnifier.prototype._show = function (e, start) {
                ...
                var hitTestInfo = this._pageView.hitTest(x, y), position = viewer._getPositionByHitTestInfo(hitTestInfo);
                if (!hitTestInfo.hitPageView) {
                    this._hide();
                    return;
                }
                if (start) {
                    wijmo.addClass(this.hostElement, _Magnifier._magnifierShowCss);
                }
            ...
            _Magnifier.prototype._hide = function () {
                wijmo.removeClass(this.hostElement, _Magnifier._magnifierShowCss);
            };
            _Magnifier.prototype.active = function () {
                this._actived = true;
                wijmo.addClass(this._viewPanelContainer, _Magnifier._magnifierActivedCss);
            };
            _Magnifier.prototype.deactive = function () {
                ...
                wijmo.removeClass(this._viewPanelContainer, _Magnifier._magnifierActivedCss);
            };
            return _Magnifier;
        }(wijmo.Control));
    ...
    (function (viewer_1) {
        ...
        var _ParametersEditor = (function (_super) {
            ...
            _ParametersEditor.prototype._render = function () {
                ...
                viewer_1._removeChildren(this.hostElement, condition);
                if (!parameters) {
                    return;
                }
                for (var i = 0; i < parameters.length; i++) {
            ...
            _ParametersEditor.prototype._generateDateTimeEditor = function (parameter) {
                ...
                if (parameter.multiValue) {
                    ...
                    if (parameter.dataType == viewer_1._ParameterType.Date
                        || parameter.dataType === viewer_1._ParameterType.DateTime) {
