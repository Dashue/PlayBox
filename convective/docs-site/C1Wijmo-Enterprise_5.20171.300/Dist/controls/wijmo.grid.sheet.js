            ...
            var _CalcEngine = (function () {
                ...
                _CalcEngine.prototype._registerLogicalFunction = function () {
                    ...
                    this._functionTable['if'] = new _FunctionDefinition(function (params, sheet) {
                        if (params.length === 3) {
                            ...
                            return sheet_1._Expression.toBoolean(params[0], sheet) ? params[1].evaluate(sheet) : false;
                        }
                    }, 3, 2);
                    // true()
                ...
                _CalcEngine.prototype._registerTextFunction = function () {
                    ...
                    this._functionTable['find'] = new _FunctionDefinition(function (params, sheet) {
                        var search = sheet_1._Expression.toString(params[0], sheet), text = sheet_1._Expression.toString(params[1], sheet), startIndex = params[2] != null ? wijmo.asInt(sheet_1._Expression.toNumber(params[2])) : 0, result;
                    ...
                    this._functionTable['search'] = new _FunctionDefinition(function (params, sheet) {
                        var search = sheet_1._Expression.toString(params[0], sheet), text = sheet_1._Expression.toString(params[1], sheet), startIndex = params[2] != null ? wijmo.asInt(sheet_1._Expression.toNumber(params[2])) : 0, adjustNum, searchRegExp, result;
                        if (text != null && search != null) {
                    ...
                    switch (this._token.tokenType) {
                        ...
                        case _TokenType.IDENTIFIER:
                            ...
                            if (funcDefinition) {
                                ...
                                x = new sheet_1._FunctionExpression(funcDefinition, params, id !== 'rand');
                                break;
                            }
                            // look for Cell Range.
        ...
        (function (sheet_1) {
            ...
            var FlexSheet = (function (_super) {
                ...
                FlexSheet.prototype._mouseUp = function (e) {
                    ...
                    if (this._htDown && this._htDown.cellType !== grid_1.CellType.None && this.selection.isValid && this.selectedSheet) {
                        if (this._htDown.cellType === grid_1.CellType.TopLeft) {
                ...
                FlexSheet.prototype._delSeletionContent = function (evt) {
                    var selections = this.selectedSheet.selectionRanges, selection, index, colIndex, rowIndex, bcol, contentDeleted = false, e, delAction = new sheet_1._EditAction(this);
                    if (this.isReadOnly) {
                        return;
                    }
                    this.beginUpdate();
                    for (index = 0; index < selections.length; index++) {
                        ...
                        e = new grid_1.CellEditEndingEventArgs(this.cells, selection, evt);
                        for (rowIndex = selection.topRow; rowIndex <= selection.bottomRow; rowIndex++) {
            ...
            var FlexSheetPanel = (function (_super) {
                ...
                FlexSheetPanel.prototype.getCellData = function (r, c, formatted) {
                    var value = _super.prototype.getCellData.call(this, r, c, formatted), col = this.columns[wijmo.asNumber(c, false, true)], bcol = this.grid ? this.grid._getBindingColumn(this, r, col) : col, cellStyle, data;
                    if (formatted) {
                ...
                FlexSheetPanel.prototype.setCellData = function (r, c, value, coerce) {
                    ...
                    if ((value && wijmo.isString(value) && value[0] === '=') || orgVal === '') {
                        coerce = false;
                    }
            ...
            var _FlexSheetValueFilterEditor = (function (_super) {
                ...
                _FlexSheetValueFilterEditor.prototype.updateEditor = function () {
                    ...
                    for (var i = 0; i < flexSheet.rows.length; i++) {
                        ...
                        if (row instanceof sheet.HeaderRow || row instanceof grid.GroupRow || (!row.visible && (currentFilterResult || !otherFilterResult))) {
                            continue;
                        }
