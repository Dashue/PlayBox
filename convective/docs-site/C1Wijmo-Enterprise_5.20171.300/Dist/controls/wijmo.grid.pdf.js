            ...
            */
            var FlexGridPdfConverter = (function () {
                ...
                */
                ...
                FlexGridPdfConverter._getGridRenderer = function (flex, range, repeatMergedValues, borderWidth, styles, lastPage) {
                    var t = (grid_1.multirow && (flex instanceof grid_1.multirow.MultiRow) && MultiRowRenderer) ||
                        (grid_1.sheet && (flex instanceof grid_1.sheet.FlexSheet) && FlexSheetRenderer) ||
            ...
            var FlexGridRenderer = (function () {
                ...
                FlexGridRenderer.prototype.isMergeableCell = function (col, row) {
                    return row.allowMerging || col.allowMerging || row instanceof grid_1.GroupRow;
                };
            ...
            var PanelSectionRenderer = (function (_super) {
                ...
                PanelSectionRenderer.prototype.render = function (doc, x, y, settings) {
                    var _this = this;
                    var ranges = this.range, pnl = this.panel, mngr = new GetMergedRangeProxy(this._gr.flex), curCellRange = new grid_1.CellRange(0, 0, 0, 0), cellRenderer = new CellRenderer(this, doc, settings, this._borderWidth);
                    if (!ranges.isValid) {
                        return;
                    }
            ...
            var CellRenderer = (function () {
                ...
                CellRenderer.prototype._getMergedCellStyle = function (row) {
                    var styles = this._pr.styles, result = _merge({}, styles.cellStyle), // merge cell styles
                ...
                CellRenderer.prototype._isBooleanCell = function (value, column, row, panel) {
                    return column.dataType === wijmo.DataType.Boolean && panel.cellType === grid_1.CellType.Cell && !this._isGroupRow(row) && this._isBoolean(value);
                };
