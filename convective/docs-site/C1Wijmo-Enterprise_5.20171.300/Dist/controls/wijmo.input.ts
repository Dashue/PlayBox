    ...
    export class ComboBox extends DropDown {
        ...
        protected _setText(text: string, fullMatch: boolean) {
            ...
            if (this._delKey) {
                ...
                if (this._delKey == Key.Back && text.length > 0 && !this.isEditable && hasItems(cv)) {
                    start--;
...
module wijmo.input {
    ...
    export class MultiAutoComplete extends AutoComplete {
         ...
         */
        selectedItemsChanged = new Event();
        /**
        ...
        private _adjustInputWidth() {
            ...
            var offsetHost = getElementRect(this.hostElement),
...
module wijmo.input {
    ...
    export class InputNumber extends Control {
        ...
        protected _setText(text: string) {
            ...
            //if (text == '-' || text == '(') {
                this._tbx.value = text;
                setSelectionRange(this._tbx, text.length);
                return;
            }
