System.register(["wijmo/wijmo.grid", "wijmo/wijmo", "wijmo/wijmo.grid.multirow"], function (exports_1, context_1) {
    "use strict";
    ...
    var wjcGrid, wjcCore, wjcSelf, _MultiRow, _Cell, _CellGroup, _MergeManager, _AddNewHandler, _NewRowTemplate, MultiRow;
    return {
        setters: [
            function (wjcGrid_1) {
                wjcGrid = wjcGrid_1;
        ...
        execute: function () {
            ...
            exports_1("_MultiRow", _MultiRow);
            'use strict';
            _Cell = (function (_super) {
            ...
            exports_1("_Cell", _Cell);
            'use strict';
            _CellGroup = (function (_super) {
                ...
                function _CellGroup(grid, options) {
                    ...
                    if (_this._colspan > _this._cells.length) {
                        _this._colspan = _this._cells.length;
                    }
                    var r = 0, c = 0;
            ...
            exports_1("_CellGroup", _CellGroup);
            'use strict';
            _MergeManager = (function (_super) {
            ...
            exports_1("_MergeManager", _MergeManager);
            'use strict';
            _AddNewHandler = (function (_super) {
                    ...
                    _this.addEventListener(_this.rowHeaders.hostElement, 'click', function (e) {
                        ...
                        if (ht.panel == _this.rowHeaders && ht.row > -1) {
                            ...
                            if (row.recordIndex != null) {
                                ...
                                _this.select(new wjcGrid.CellRange(top, 0, top + _this.rowsPerItem - 1, _this.columns.length - 1));
                            }
                        }
                    });
