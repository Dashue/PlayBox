System.register(["wijmo/wijmo", "wijmo/wijmo.chart"], function (exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_1("DataPoint", DataPoint);
            RenderEventArgs = (function (_super) {
            ...
            exports_1("RenderEventArgs", RenderEventArgs);
            SeriesRenderingEventArgs = (function (_super) {
            ...
            exports_1("SeriesRenderingEventArgs", SeriesRenderingEventArgs);
            (function (ImageFormat) {
                ImageFormat[ImageFormat["Png"] = 0] = "Png";
                ImageFormat[ImageFormat["Jpeg"] = 1] = "Jpeg";
                ImageFormat[ImageFormat["Svg"] = 2] = "Svg";
            })(ImageFormat || (ImageFormat = {}));
            exports_1("ImageFormat", ImageFormat);
            ;
            FlexChartBase = (function (_super) {
                ...
                FlexChartBase.prototype._exportToImage = function (extension, processDataURI) {
                    ...
                    if (extension === 'svg') {
                        ...
                        image.onload = function () {
                            var canvas = document.createElement('canvas'), rect = wjcCore.getElementRect(ele), uri;
            ...
            exports_1("FlexChartBase", FlexChartBase);
            _KeyWords = (function () {
                function _KeyWords() {
                    this._keys = {};
            ...
            ExportHelper = (function () {
                ...
                ExportHelper.getDataUri = function (ele) {
                    ...
                    if (ele.tagName == 'svg') {
                        rect = wjcCore.getElementRect(ele);
                        width = rect.width || 0;
            ...
            exports_1("_PieSegment", _PieSegment);
            _DonutSegment = (function () {
            ...
            exports_1("_DonutSegment", _DonutSegment);
            'use strict';
            (function (Stacking) {
            ...
            FlexChartCore = (function (_super) {
                ...
                FlexChartCore.prototype._renderLegendElements = function (engine, series, pos, areas, isVertical, width, height) {
                    var pos0 = pos.clone();
                    var rh = 0, cw = 0;
                    if (!series) {
                        return;
            ...
            exports_1("FlexChartCore", FlexChartCore);
            _AreaDef = (function () {
                function _AreaDef() {
            ...
            exports_1("_DataInfo", _DataInfo);
            ChartTooltip = (function (_super) {
            ...
            exports_1("ChartTooltip", ChartTooltip);
            'use strict';
            (function (ChartType) {
            ...
            exports_1("OverlappingLabels", OverlappingLabels);
            (function (TickMark) {
            ...
            Axis = (function () {
                ...
                Axis.prototype._renderLabelsAndTicks = function (engine, index, val, sval, labelAngle, tickMarks, showLabel, t1, t2) {
                    var pos = this._getPosition();
                    var hasLbl = true, isVert = this.axisType == AxisType.Y, isNear = pos != Position.Top && pos != Position.Right, labelPadding = this.labelPadding || 2, tth = this._TICK_WIDTH, lalign = this._getLabelAlign(isVert), lblClass = FlexChart._CSS_LABEL, glineClass = FlexChart._CSS_GRIDLINE, tickClass = FlexChart._CSS_TICK, gstroke = FlexChart._FG, tstroke = FlexChart._FG, gth = this._GRIDLINE_WIDTH;
            ...
            Axis._id = 0;
            exports_1("Axis", Axis);
            AxisCollection = (function (_super) {
            ...
            exports_1("AxisCollection", AxisCollection);
            (function (_tmInc) {
            ...
            exports_1("PlotArea", PlotArea);
            PlotAreaCollection = (function (_super) {
            ...
            exports_1("PlotAreaCollection", PlotAreaCollection);
            ...
            exports_1("SeriesVisibility", SeriesVisibility);
            (function (Marker) {
            ...
            exports_1("DataArray", DataArray);
            SeriesEventArgs = (function (_super) {
            ...
            exports_1("SeriesEventArgs", SeriesEventArgs);
            SeriesBase = (function () {
            ...
            exports_1("SeriesBase", SeriesBase);
            'use strict';
            ...
            exports_1("_SvgRenderEngine", _SvgRenderEngine);
            _GradientColorUtil = (function () {
            ...
            exports_1("ChartElement", ChartElement);
            ;
            ...
            exports_1("LabelPosition", LabelPosition);
            ;
            ...
            exports_1("PieLabelPosition", PieLabelPosition);
            ;
            DataLabelRenderEventArgs = (function (_super) {
            ...
            exports_1("DataLabelRenderEventArgs", DataLabelRenderEventArgs);
            DataLabelBase = (function () {
            ...
            exports_1("DataLabelBase", DataLabelBase);
            DataLabel = (function (_super) {
            ...
            exports_1("DataLabel", DataLabel);
            PieDataLabel = (function (_super) {
            ...
            exports_1("PieDataLabel", PieDataLabel);
            'use strict';
            ...
            })(LineMarkerLines || (LineMarkerLines = {}));
            exports_1("LineMarkerLines", LineMarkerLines);
            ...
            })(LineMarkerInteraction || (LineMarkerInteraction = {}));
            exports_1("LineMarkerInteraction", LineMarkerInteraction);
            ...
            })(LineMarkerAlignment || (LineMarkerAlignment = {}));
            exports_1("LineMarkerAlignment", LineMarkerAlignment);
            LineMarker = (function () {
            ...
            exports_1("LineMarker", LineMarker);
            'use strict';
            _DataPoint = (function () {
            ...
            exports_1("_DataPoint", _DataPoint);
            ...
            })(_MeasureOption || (_MeasureOption = {}));
            exports_1("_MeasureOption", _MeasureOption);
            _RectArea = (function () {
            ...
            exports_1("_RectArea", _RectArea);
            _CircleArea = (function () {
            ...
            exports_1("_CircleArea", _CircleArea);
            _LinesArea = (function () {
            ...
            exports_1("_LinesArea", _LinesArea);
            _HitResult = (function () {
                function _HitResult() {
                }
                return _HitResult;
            }());
            exports_1("_HitResult", _HitResult);
            _HitTester = (function () {
            ...
            exports_1("_HitTester", _HitTester);
            'use strict';
            _BasePlotter = (function () {
                ...
                _BasePlotter.prototype._renderLabel = function (engine, map, dp, chart, lbl, series, offset, lblAreas) {
                    var pos = lbl.position, bdr = lbl.border, line = lbl.connectingLine, marg = 2;
            ...
            exports_1("_BasePlotter", _BasePlotter);
            'use strict';
            _BarPlotter = (function (_super) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            if (_DataInfo.isValid(datax) && _DataInfo.isValid(datay)) {
                                if (stacked) {
                                    ...
                                    var y = ay.convert(datay), rect = new wjcCore.Rect(Math.min(x0, x1), Math.min(y, originScreen), Math.abs(x1 - x0), Math.abs(originScreen - y));
                                    if (customRender) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            if (_DataInfo.isValid(datax) && _DataInfo.isValid(datay)) {
                                if (stacked) {
                                    ...
                                    y0 = ay.convert(y0);
                                    y1 = ay.convert(y1);
                                    var x = ax.convert(datay), rect = new wjcCore.Rect(Math.min(x, originScreen), Math.min(y0, y1), Math.abs(originScreen - x), Math.abs(y1 - y0));
                                    if (customRender) {
            ...
            exports_1("_BarPlotter", _BarPlotter);
            'use strict';
            _LinePlotter = (function (_super) {
            ...
            exports_1("_LinePlotter", _LinePlotter);
            'use strict';
            _AreaPlotter = (function (_super) {
            ...
            exports_1("_AreaPlotter", _AreaPlotter);
            'use strict';
            _BubblePlotter = (function (_super) {
            ...
            exports_1("_BubblePlotter", _BubblePlotter);
            'use strict';
            _FinancePlotter = (function (_super) {
            ...
            exports_1("_FinancePlotter", _FinancePlotter);
            'use strict';
            _FunnelPlotter = (function (_super) {
            ...
            exports_1("_FunnelPlotter", _FunnelPlotter);
            _FunnelSegment = (function () {
            ...
            exports_1("_FunnelSegment", _FunnelSegment);
            "use strict";
            _VolumeHelper = (function () {
            ...
            exports_1("_VolumeHelper", _VolumeHelper);
        }
    };
});
