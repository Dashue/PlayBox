System.register(["wijmo/wijmo", "wijmo/wijmo.grid.filter", "wijmo/wijmo.input", "wijmo/wijmo.grid", "wijmo/wijmo.chart", "wijmo/wijmo.olap"], function (exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            _PivotKey = (function () {
                ...
                _PivotKey.prototype.getValue = function (index, formatted) {
                    ...
                    if (formatted && !wjcCore.isString(val)) {
                        val = wjcCore.Globalize.format(this.values[index], this.fields[index].format);
                    }
                    return val;
                };
            ...
            exports_1("_PivotNode", _PivotNode);
            'use strict';
            PivotCollectionView = (function (_super) {
            ...
            exports_1("PivotCollectionView", PivotCollectionView);
            'use strict';
            PivotField = (function () {
            ...
            exports_1("PivotField", PivotField);
            CubePivotField = (function (_super) {
                ...
                function CubePivotField(engine, binding, header, options) {
                    ...
                    var hasBinding = _this.binding != null && binding.length > 0;
                    if (_this.subFields != null && _this.subFields.length > 0) {
            ...
            exports_1("CubePivotField", CubePivotField);
            ...
            exports_1("DimensionType", DimensionType);
            'use strict';
            PivotFieldCollection = (function (_super) {
            ...
            exports_1("PivotFieldCollection", PivotFieldCollection);
            'use strict';
            PivotFilter = (function () {
            ...
            exports_1("PivotFilter", PivotFilter);
            'use strict';
            ...
            PivotFieldEditor = (function (_super) {
                ...
                function PivotFieldEditor(element, options) {
                    ...
                    _this._gDlg.textContent = g.dialogHeader;
                    _this._gHdr.textContent = g.header;
                    _this._gAgg.textContent = g.summary;
                    _this._gShw.textContent = g.showAs,
                        _this._gWfl.textContent = g.weighBy;
                    _this._gSrt.textContent = g.sort;
                    _this._gFlt.textContent = g.filter;
                    _this._gFmt.textContent = g.format;
                    _this._gSmp.textContent = g.sample;
                    _this._btnFltEdt.textContent = g.edit;
                    _this._btnFltClr.textContent = g.clear;
                    _this._btnApply.textContent = g.ok;
                    _this._btnCancel.textContent = g.cancel;
                ...
                PivotFieldEditor.prototype.containsFocus = function () {
                    return _super.prototype.containsFocus.call(this) || wjcCore.contains(this._dFlt, wjcCore.getActiveElement());
                };
                PivotFieldEditor.prototype._initAggregateOptions = function () {
                    var _this = this;
                    var g = wjcCore.culture.olap.PivotFieldEditor.aggs, list = [
                        { key: g.sum, val: wjcCore.Aggregate.Sum, all: false },
                        { key: g.cnt, val: wjcCore.Aggregate.Cnt, all: true },
                        { key: g.avg, val: wjcCore.Aggregate.Avg, all: false },
                        { key: g.max, val: wjcCore.Aggregate.Max, all: true },
                        { key: g.min, val: wjcCore.Aggregate.Min, all: true },
                        { key: g.rng, val: wjcCore.Aggregate.Rng, all: false },
                        { key: g.std, val: wjcCore.Aggregate.Std, all: false },
                        { key: g.var, val: wjcCore.Aggregate.Var, all: false },
                        { key: g.stdp, val: wjcCore.Aggregate.StdPop, all: false },
                        { key: g.varp, val: wjcCore.Aggregate.VarPop, all: false },
                        { key: g.first, val: wjcCore.Aggregate.First, all: true },
                        { key: g.last, val: wjcCore.Aggregate.Last, all: true },
                    ];
            ...
            PivotFieldEditor.controlTemplate = '<div>' +
                ...
                '</div>' +
                '</div>';
            exports_1("PivotFieldEditor", PivotFieldEditor);
            'use strict';
            PivotFilterEditor = (function (_super) {
                ...
                function PivotFilterEditor(element, field, options) {
                    ...
                    _this._btnOk.textContent = wjcCore.culture.olap.PivotFieldEditor.ok;
                    var bnd = _this._btnClicked.bind(_this);
                    _this._btnOk.addEventListener('click', bnd);
            ...
            PivotFilterEditor.controlTemplate = '<div>' +
                ...
                '</div>';
            exports_1("PivotFilterEditor", PivotFilterEditor);
            'use strict';
            wjcCore.culture.olap = wjcCore.culture.olap || {};
            ...
            exports_1("ShowTotals", ShowTotals);
            (function (ShowAs) {
            ...
            exports_1("ShowAs", ShowAs);
            PivotEngine = (function () {
                        ...
                        if (viewDef) {
                            this.deferUpdate(function () {
                                ...
                                for (var i = 0; i < viewDef.fields.length; i++) {
                                    var fldDef = viewDef.fields[i], f = new PivotField(_this, fldDef.binding, fldDef.header);
                                    f._autoGenerated = true;
                                    _this._copyProps(f, fldDef, PivotField._props);
                                    if (fldDef.filter) {
                ...
                PivotEngine.prototype._updateTallies = function (arr, startIndex) {
                    ...
                    var rkLen = this._rowFields.length, rkStart = this._showRowTotals == ShowTotals.None ? rkLen : 0, rkStep = this._showRowTotals == ShowTotals.GrandTotals ? Math.max(1, rkLen) : 1, ckLen = this._columnFields.length, ckStart = this._showColTotals == ShowTotals.None ? ckLen : 0, ckStep = this._showColTotals == ShowTotals.GrandTotals ? Math.max(1, ckLen) : 1, vfLen = this._valueFields.length;
                    for (var index = startIndex; index < arrLen; index++) {
                        ...
                        if (!this._activeFilterFields.length || this._applyFilter(item)) {
                            ...
                            for (var i = rkStart; i <= rkLen; i += rkStep, nd = nd.parent) {
                                var nd = rowNodes.getNode(this._rowFields, i, null, -1, item), rowKey = nd.key, rowKeyId = rowKey.toString(), rowTallies = this._tallies[rowKeyId];
                                if (!rowTallies) {
                                ...
                                for (var j = ckStart; j <= ckLen; j += ckStep) {
                                    for (var k = 0; k < vfLen; k++) {
                                        var colNodes = nd.tree.getNode(this._columnFields, j, this._valueFields, k, item), colKey = colNodes.key, colKeyId = colKey.toString(), tally = rowTallies[colKeyId];
                                        if (!tally) {
                ...
                PivotEngine.prototype._getRunningTotal = function (arr, row, col, showAs) {
                    ...
                    var binding = this._colBindings[col], runTot = arr[row][binding];
                ...
                PivotEngine.prototype._getLastValueInRowGroup = function (arr, row, col) {
                    ...
                    var level = this._getRowLevel(row), grpFld = this.rowFields.length - 2;
            ...
            exports_1("PivotEngine", PivotEngine);
            ProgressEventArgs = (function (_super) {
            ...
            exports_1("ProgressEventArgs", ProgressEventArgs);
            'use strict';
            _ServerConnection = (function () {
                ...
                _ServerConnection.prototype.getFields = function () {
                    var xhr = wjcCore.httpRequest(this._getUrl('Fields'), { async: false });
                ...
                _ServerConnection.prototype._getResults = function (callBack) {
                    ...
                    this._sendHttpRequest('Result', {
                        success: function (xhr) {
                            ...
                            var dateFields = _this._ng.columnFields.filter(function (item) {
                                return item.dataType == wjcCore.DataType.Date;
                            }).concat(_this._ng.rowFields.filter(function (item) {
                                return item.dataType == wjcCore.DataType.Date;
                            }));
            ...
            exports_1("_ServerConnection", _ServerConnection);
            _ServerTally = (function (_super) {
                ...
                _ServerTally.prototype.add = function (value, weight) {
                    ...
                    _super.prototype.add.call(this, value, weight);
                };
            ...
            _ListContextMenu = (function (_super) {
                ...
                _ListContextMenu.prototype._execute = function (parm) {
                    ...
                    switch (parm) {
                        ...
                        case 'last':
                            if (ng) {
                                var index = flds.indexOf(fld), newIndex = parm == 'up' ? index - 1 :
                                    parm == 'first' ? 0 :
                                        parm == 'down' ? index + 1 :
                ...
                _ListContextMenu.prototype._canExecute = function (parm) {
                    var grid = wjcCore.Control.getControl(this.owner), row = grid.selection.row, fld = grid.rows[row].dataItem, ng = fld ? fld.engine : null, target = this._getTargetList(ng, parm);
                    switch (parm) {
                        case 'up':
                        case 'first':
                            return row > 0;
            ...
            exports_1("_ListContextMenu", _ListContextMenu);
            'use strict';
            wjcCore.culture.olap = wjcCore.culture.olap || {};
            ...
            PivotPanel = (function (_super) {
                ...
                PivotPanel.prototype._globalize = function () {
                    var g = wjcCore.culture.olap.PivotPanel;
                ...
                PivotPanel.prototype._drop = function (e) {
                    ...
                    var target = this._getFlexGridTarget(e);
                    if (target && this._dragField) {
                        var source = wjcCore.Control.getControl(this._dragSource), fld = this._dragField;
                        ...
                        if (target == this._lbFields) {
                            ...
                            this._ng.deferUpdate(function () {
                                var items = target.itemsSource, index = items.indexOf(fld);
                ...
                PivotPanel.prototype._getFlexGridTarget = function (e) {
                    ...
                    return grid instanceof wjcGrid.FlexGrid
                        ? grid
                        : null;
                };
            ...
            'use strict';
            _GridContextMenu = (function (_super) {
                ...
                _GridContextMenu.prototype._canExecute = function (parm) {
                    var g = wjcCore.Control.getControl(this.owner), ng = g.engine, fld = this._targetField;
                    switch (parm) {
                        case 'remove':
                            return fld != null;
                        case 'edit':
            ...
            exports_1("_GridContextMenu", _GridContextMenu);
            'use strict';
            _PivotMergeManager = (function (_super) {
            ...
            exports_1("_PivotMergeManager", _PivotMergeManager);
            'use strict';
            PivotGrid = (function (_super) {
                ...
                PivotGrid.prototype._updateFixedContent = function () {
                    ...
                    p = this.rowHeaders;
                    for (var r = 0; r < p.rows.length; r++) {
                        var k = p.rows[r].dataItem[_PivotKey._ROW_KEY_NAME];
            ...
            DetailDialog.controlTemplate = '<div>' +
                ...
                '</div>' +
                '</div>';
            exports_1("DetailDialog", DetailDialog);
            'use strict';
            wjcCore.culture.olap = wjcCore.culture.olap || {};
            ...
            exports_1("PivotChartType", PivotChartType);
            ...
            exports_1("LegendVisibility", LegendVisibility);
            PivotChart = (function (_super) {
                ...
                PivotChart.prototype._createFlexChart = function () {
                    ...
                    this._flexChart.tooltip.content = function (ht) {
                        var content = ht.name
                            ? '<b>' + ht.name + '</b> ' + '<br/>'
                            : '';
                        content += _this._getLabel(ht.x) + ' ' + ht._yfmt;
                        return content;
                    };
                ...
                PivotChart.prototype._createFlexPie = function () {
                    ...
                    this._flexPie.tooltip.content = function (ht) {
                        return '<b>' + _this._getLabel(_this._dataItms[ht.pointIndex][_PivotKey._ROW_KEY_NAME]) + '</b> ' + '<br/>' + ht._yfmt;
                    };
                ...
                PivotChart.prototype._getLegendPosition = function (isPie) {
