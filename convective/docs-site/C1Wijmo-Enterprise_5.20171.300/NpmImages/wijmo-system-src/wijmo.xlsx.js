System.register(["wijmo/wijmo", "wijmo/wijmo.xlsx"], function (exports_1, context_1) {
    ...
    var wjcCore, wjcSelf, JSZip, _xlsx, _Promise, _CompositedPromise, Workbook, WorkSheet, WorkbookColumn, WorkbookRow, WorkbookCell, WorkbookFrozenPane, WorkbookStyle, WorkbookFont, WorkbookFill, WorkbookBorder, WorkbookBorderSetting, HAlign, VAlign, BorderStyle;
    return {
        setters: [
            function (wjcCore_1) {
                wjcCore = wjcCore_1;
