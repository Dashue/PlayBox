System.register(["wijmo/wijmo", "wijmo/wijmo.gauge"], function (exports_1, context_1) {
    "use strict";
    ...
    var wjcCore, wjcSelf, ShowText, Gauge, GaugeDirection, LinearGauge, RadialGauge, BulletGraph, Range;
    return {
        setters: [
            function (wjcCore_1) {
                wjcCore = wjcCore_1;
        ...
        execute: function () {
            ...
            Gauge = (function (_super) {
                ...
                function Gauge(element, options) {
                    ...
                    _this.addEventListener(_this.hostElement, 'mousemove', function (e) {
                        if (e.buttons == 1) {
                            _this._applyMouseValue(e, true);
                        }
                    });
                    if ('ontouchstart' in window) {
                        _this.addEventListener(_this.hostElement, 'touchstart', function (e) {
                            _this.focus();
                            if (!e.defaultPrevented && !_this.isReadOnly && _this._applyMouseValue(e, true)) {
                                e.preventDefault();
                            }
                        });
                        _this.addEventListener(_this.hostElement, 'touchmove', function (e) {
                            if (!e.defaultPrevented && !_this.isReadOnly && _this._applyMouseValue(e, true)) {
                                e.preventDefault();
                            }
                        });
                ...
                Gauge.prototype._rangeChanged = function (rng, e) {
                    ...
                    if (rng == this._pointer && e.propertyName == 'max') {
                        ...
                        if (this.isAnimated && !this.isUpdating && this._initialized) {
                            var s1 = this._getPointerColor(e.oldValue), s2 = this._getPointerColor(e.newValue), c1 = s1 ? new wjcCore.Color(s1) : null, c2 = s2 ? new wjcCore.Color(s2) : null;
            ...
            exports_1("GaugeDirection", GaugeDirection);
