System.register(["wijmo/wijmo.pdf", "wijmo/wijmo.grid", "wijmo/wijmo", "wijmo/wijmo.grid.pdf"], function (exports_1, context_1) {
    "use strict";
    ...
    var wjcPdf, wjcGrid, wjcCore, wjcSelf, ScaleMode, ExportMode, PdfFormatItemEventArgs, globCell, FlexGridPdfConverter, FlexGridRenderer, FlexSheetRenderer, MultiRowRenderer, PanelSection, PanelSectionRenderer, CellRenderer, GetMergedRangeProxy, CellRangeExt, RowRange, PdfPageRowRange;
    return {
        setters: [
            function (wjcPdf_1) {
                wjcPdf = wjcPdf_1;
        ...
        execute: function () {
            ...
            exports_1("ScaleMode", ScaleMode);
            (function (ExportMode) {
                ExportMode[ExportMode["All"] = 0] = "All";
                ExportMode[ExportMode["Selection"] = 1] = "Selection";
            })(ExportMode || (ExportMode = {}));
            exports_1("ExportMode", ExportMode);
            PdfFormatItemEventArgs = (function (_super) {
            ...
            exports_1("PdfFormatItemEventArgs", PdfFormatItemEventArgs);
            FlexGridPdfConverter = (function () {
                ...
                FlexGridPdfConverter._getGridRenderer = function (flex, range, repeatMergedValues, borderWidth, styles, lastPage) {
            ...
            exports_1("FlexGridPdfConverter", FlexGridPdfConverter);
            FlexGridRenderer = (function () {
                function FlexGridRenderer(flex, range, repeatMergedValues, borderWidth, styles, lastPage) {
                    this._flex = flex;
                ...
                FlexGridRenderer.prototype.render = function (doc, settings) {
            ...
            FlexSheetRenderer = (function (_super) {
                __extends(FlexSheetRenderer, _super);
                function FlexSheetRenderer(flex, range, repeatMergedValues, borderWidth, styles, lastPage) {
                    return _super.call(this, flex, range, repeatMergedValues, borderWidth, styles, lastPage) || this;
                }
            ...
            MultiRowRenderer = (function (_super) {
                __extends(MultiRowRenderer, _super);
                function MultiRowRenderer(multirow, range, repeatMergedValues, borderWidth, styles, lastPage) {
                    return _super.call(this, multirow, range, repeatMergedValues, borderWidth, styles, lastPage) || this;
                }
            ...
            PanelSectionRenderer = (function (_super) {
                __extends(PanelSectionRenderer, _super);
                function PanelSectionRenderer(gr, panel, range, repeatMergedValues, borderWidth, styles) {
                    var _this = _super.call(this, panel, range) || this;
                    _this._gr = gr;
                    _this._repeatMergedValues = repeatMergedValues;
                ...
                Object.defineProperty(PanelSectionRenderer.prototype, "styles", {
                    get: function () {
                        return this._styles;
                    },
                    enumerable: true,
                ...
                PanelSectionRenderer.prototype.render = function (doc, x, y, settings) {
                    var _this = this;
                    var ranges = this.range, pnl = this.panel, mngr = new GetMergedRangeProxy(this._gr.flex), curCellRange = new wjcGrid.CellRange(0, 0, 0, 0), cellRenderer = new CellRenderer(this, doc, settings, this._borderWidth);
                    if (!ranges.isValid) {
                        return;
                    }
                    var pY = {};
            ...
            CellRenderer = (function () {
                function CellRenderer(panelRenderer, area, settings, borderWidth) {
                ...
                CellRenderer.prototype.renderCell = function (value, row, column, rng, r) {
                    ...
                    }, customContent = !!this._settings.customCellContent, gridCell = null, style = this._getMergedCellStyle(row);
                    if (customContent) {
                    ...
                    if (wjcCore.isFunction(this._settings.formatItem)) {
                        formatEventArgs = new PdfFormatItemEventArgs(panel, rng, gridCell, this._area, m.rect, m.contentRect, m.textRect.top, style, function () {
                ...
                CellRenderer.prototype._renderCell = function (value, row, column, rng, m, style, renderContent, renderBorders) {
                    ...
                    var panel = this._pr.panel, grid = panel.grid;
                ...
                CellRenderer.prototype._getMergedCellStyle = function (row) {
                    var styles = this._pr.styles, result = _merge({}, styles.cellStyle), panel = this._pr.panel;
                    switch (panel.cellType) {
                        case wjcGrid.CellType.Cell:
                            if (this._isGroupRow(row)) {
                                ...
                                if (this._pr.gr.isAlternatingRow(row)) {
                ...
                CellRenderer.prototype._isBooleanCell = function (value, column, row, panel) {
                ...
                CellRenderer.prototype._isGroupRow = function (row) {
                ...
                CellRenderer.prototype._renderEmptyCell = function (m, style, renderContent, renderBorders) {
                    var x = m.rect.left, y = m.rect.top, clientWidth = m.clientRect.width, clientHeight = m.clientRect.height, height = m.rect.height, width = m.rect.width, blw = m.clientRect.left - m.rect.left, btw = m.clientRect.top - m.rect.top, bbw = (m.rect.top + m.rect.height) - (m.clientRect.top + m.clientRect.height), brw = (m.rect.left + m.rect.width) - (m.clientRect.left + m.clientRect.width);
            ...
            CellRangeExt = (function (_super) {
                __extends(CellRangeExt, _super);
                function CellRangeExt(panel, cr) {
                    var _this = _super.call(this, cr.row, cr.col, cr.row2, cr.col2) || this;
                    _this.firstVisibleRow = -1;
                    var tr = _this.topRow, br = _this.bottomRow;
                    for (var i = tr; i < br; i++) {
