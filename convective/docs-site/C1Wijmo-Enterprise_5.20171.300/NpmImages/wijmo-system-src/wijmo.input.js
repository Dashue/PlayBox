System.register(["wijmo/wijmo", "wijmo/wijmo.input"], function (exports_1, context_1) {
    "use strict";
    ...
    var wjcCore, wjcSelf, DropDown, DateSelectionMode, Calendar, ColorPicker, ListBox, FormatItemEventArgs, ComboBox, AutoComplete, Menu, MultiSelect, MultiAutoComplete, PopupTrigger, Popup, InputDate, InputTime, InputDateTime, InputNumber, InputMask, InputColor;
    return {
        setters: [
            function (wjcCore_1) {
                wjcCore = wjcCore_1;
        ...
        execute: function () {
            ...
            exports_1("DateSelectionMode", DateSelectionMode);
            ...
            exports_1("PopupTrigger", PopupTrigger);
