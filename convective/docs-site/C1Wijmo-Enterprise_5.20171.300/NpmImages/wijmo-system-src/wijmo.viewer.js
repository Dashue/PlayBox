System.register(["wijmo/wijmo", "wijmo/wijmo.input", "wijmo/wijmo.grid", "wijmo/wijmo.viewer"], function (exports_1, context_1) {
    "use strict";
    ...
    exports_1("_pointMove", _pointMove);
    ...
    exports_1("_createSvgBtn", _createSvgBtn);
    ...
    exports_1("_setLandscape", _setLandscape);
    ...
    exports_1("_clonePageSettings", _clonePageSettings);
    ...
    exports_1("_enumToArray", _enumToArray);
    ...
    exports_1("_removeChildren", _removeChildren);
    ...
    exports_1("_removeEvent", _removeEvent);
    ...
    exports_1("_checkImageButton", _checkImageButton);
    ...
    exports_1("_disableImageButton", _disableImageButton);
    ...
    exports_1("_addWjHandler", _addWjHandler);
    ...
    exports_1("_removeAllWjHandlers", _removeAllWjHandlers);
    ...
    exports_1("_getErrorMessage", _getErrorMessage);
    ...
    exports_1("_hasScrollbar", _hasScrollbar);
    ...
    exports_1("_transformSvg", _transformSvg);
    ...
    exports_1("_getTransformedPosition", _getTransformedPosition);
    ...
    exports_1("_getRotatedSize", _getRotatedSize);
    ...
    exports_1("_getPositionByHitTestInfo", _getPositionByHitTestInfo);
    ...
    exports_1("_statusJsonReviver", _statusJsonReviver);
    ...
    exports_1("_pageSettingsJsonReviver", _pageSettingsJsonReviver);
    function _strEndsWith(text, suffix) {
        return text.slice(-suffix.length) === suffix;
    }
    exports_1("_strEndsWith", _strEndsWith);
    ...
    exports_1("_appendQueryString", _appendQueryString);
    function _joinUrl() {
        var data = [];
    ...
    exports_1("_joinStringUrl", _joinStringUrl);
    ...
    exports_1("_prepareStringUrl", _prepareStringUrl);
    ...
    exports_1("_httpRequest", _httpRequest);
    ...
    exports_1("_objToParams", _objToParams);
    function _disableCache(url) {
        return url + (url.indexOf('?') == -1 ? '?' : '&') + '_=' + new Date().getTime();
    }
    exports_1("_disableCache", _disableCache);
    function _parseReportExecutionInfo(json) {
        return JSON.parse(json, _statusJsonReviver);
    }
    exports_1("_parseReportExecutionInfo", _parseReportExecutionInfo);
    function _parseExecutionInfo(json) {
        return JSON.parse(json, _statusJsonReviver);
    }
    exports_1("_parseExecutionInfo", _parseExecutionInfo);
    function _getTouchEventMap() {
        return ('ontouchstart' in window) ? _touchEventsMap : _pointerEventsMap;
    }
    exports_1("_getTouchEventMap", _getTouchEventMap);
    var wjcCore, wjcInput, wjcGrid, wjcSelf, _svgStart, _svgEnd, icons, _hiddenCss, _commandTagAttr, _ActionQueue, _checkedCss, _disabledCss, wjEventsName, _DocumentSource, _DocumentService, _UnitType, _Unit, _Promise, _CompositedPromise, _PaperKind, QueryLoadingDataEventArgs, _Report, _ReportService, _ExecutionStatus, _ParameterType, CatalogItemType, _PdfDocumentSource, _PdfDocumentService, _SearchManager, _eventSeparator, _touchEventsMap, _pointerEventsMap, _TouchDirection, _TouchInfo, _SpeedReducer, _TouchEventType, _TouchEventArgs, _TouchEvent, _TouchTrigger, _PanEventArgs, _PanEvent, _PanTrigger, _SwipeEventArgs, _SwipeEvent, _SwipeTrigger, _PinchEventArgs, _PinchEvent, _PinchTrigger, _TouchManager, _PageSetupEditor, _ExportOptionEditor, _Toolbar, _ViewerToolbarBase, _ViewerToolbar, _ViewerMiniToolbar, _ViewerMobileToolbarBase, _ViewerMobileToolbar, _ViewerZoomBar, _SearchBar, _RotateAngle, _Page, _CompositePageView, _PageViewBase, _Scroller, _VScroller, _SinglePageView, _ContinuousPageView, _SideTabs, _TabPage, _ViewerMenuBase, _HamburgerMenu, _ViewMenu, _SearchOptionsMenu, MouseMode, ViewMode, ZoomMode, _LinkClickedEventArgs, _HistoryManager, ViewerBase, _PageSetupDialog, _ViewerActionType, _Rubberband, _Magnifier, parametersIcon, ReportViewer, _ParametersEditor, _MultiSelectEx, _ReportHamburgerMenu, PdfViewer;
    return {
        setters: [
            function (wjcCore_1) {
                wjcCore = wjcCore_1;
        ...
        execute: function () {
            ...
            }), exports_1("_hiddenCss", _hiddenCss = 'hidden'), exports_1("_commandTagAttr", _commandTagAttr = 'command-tag');
            _ActionQueue = (function () {
            ...
            exports_1("_ActionQueue", _ActionQueue);
            _checkedCss = 'wj-state-active', _disabledCss = 'wj-state-disabled';
            wjEventsName = '__wjEvents';
            'use strict';
            _DocumentSource = (function () {
                ...
                _DocumentSource._isMobile = function () {
                ...
                _DocumentSource._isIOS = function () {
            ...
            _DocumentSource._isMobileEnvironment = null;
            _DocumentSource._isIOSEnvironment = null;
            exports_1("_DocumentSource", _DocumentSource);
            _DocumentService = (function () {
            ...
            exports_1("_DocumentService", _DocumentService);
            (function (_UnitType) {
            ...
            })(_PaperKind || (_PaperKind = {}));
            exports_1("_PaperKind", _PaperKind);
            QueryLoadingDataEventArgs = (function (_super) {
            ...
            exports_1("QueryLoadingDataEventArgs", QueryLoadingDataEventArgs);
            'use strict';
            _Report = (function (_super) {
            ...
            exports_1("_Report", _Report);
            _ReportService = (function (_super) {
            ...
            exports_1("_ReportService", _ReportService);
            _ExecutionStatus = (function () {
            ...
            exports_1("_ExecutionStatus", _ExecutionStatus);
            ...
            exports_1("_ParameterType", _ParameterType);
            ...
            exports_1("CatalogItemType", CatalogItemType);
            'use strict';
            _PdfDocumentSource = (function (_super) {
            ...
            exports_1("_PdfDocumentSource", _PdfDocumentSource);
            _PdfDocumentService = (function (_super) {
            ...
            exports_1("_PdfDocumentService", _PdfDocumentService);
            ...
            _SearchManager = (function () {
                ...
                _SearchManager.prototype._getSearchResults = function () {
                    ...
                    return this.documentSource.search({ text: this.text, matchCase: this.matchCase, wholeWord: this.wholeWord }).then(function (v) {
            ...
            exports_1("_SearchManager", _SearchManager);
            ...
            _eventSeparator = ',', _touchEventsMap = {
            ...
            })(_TouchDirection || (_TouchDirection = {}));
            exports_1("_TouchDirection", _TouchDirection);
            _TouchInfo = (function () {
            ...
            exports_1("_TouchInfo", _TouchInfo);
            _SpeedReducer = (function () {
            ...
            exports_1("_SpeedReducer", _SpeedReducer);
            ...
            exports_1("_TouchEventType", _TouchEventType);
            _TouchEventArgs = (function (_super) {
            ...
            exports_1("_TouchEventArgs", _TouchEventArgs);
            _TouchEvent = (function (_super) {
            ...
            exports_1("_TouchEvent", _TouchEvent);
            _TouchTrigger = (function () {
            ...
            exports_1("_TouchTrigger", _TouchTrigger);
            _PanEventArgs = (function (_super) {
            ...
            exports_1("_PanEventArgs", _PanEventArgs);
            _PanEvent = (function (_super) {
            ...
            exports_1("_PanEvent", _PanEvent);
            _PanTrigger = (function (_super) {
            ...
            exports_1("_PanTrigger", _PanTrigger);
            _SwipeEventArgs = (function (_super) {
            ...
            exports_1("_SwipeEventArgs", _SwipeEventArgs);
            _SwipeEvent = (function (_super) {
            ...
            exports_1("_SwipeEvent", _SwipeEvent);
            _SwipeTrigger = (function (_super) {
            ...
            exports_1("_SwipeTrigger", _SwipeTrigger);
            _PinchEventArgs = (function (_super) {
            ...
            exports_1("_PinchEventArgs", _PinchEventArgs);
            _PinchEvent = (function (_super) {
            ...
            exports_1("_PinchEvent", _PinchEvent);
            _PinchTrigger = (function (_super) {
            ...
            exports_1("_PinchTrigger", _PinchTrigger);
            _TouchManager = (function () {
            ...
            _TouchManager._allTouchInfos = [];
            exports_1("_TouchManager", _TouchManager);
            'use strict';
            _PageSetupEditor = (function (_super) {
            ...
            _PageSetupEditor.controlTemplate = '<div>' +
                ...
                '</div>' +
                '</div>';
            exports_1("_PageSetupEditor", _PageSetupEditor);
            _ExportOptionEditor = (function (_super) {
            ...
            exports_1("_ExportOptionEditor", _ExportOptionEditor);
            'use strict';
            _Toolbar = (function (_super) {
            ...
            exports_1("_Toolbar", _Toolbar);
            _ViewerToolbarBase = (function (_super) {
            ...
            exports_1("_ViewerToolbarBase", _ViewerToolbarBase);
            _ViewerToolbar = (function (_super) {
            ...
            exports_1("_ViewerToolbar", _ViewerToolbar);
            _ViewerMiniToolbar = (function (_super) {
            ...
            exports_1("_ViewerMiniToolbar", _ViewerMiniToolbar);
            _ViewerMobileToolbarBase = (function (_super) {
            ...
            exports_1("_ViewerMobileToolbarBase", _ViewerMobileToolbarBase);
            _ViewerMobileToolbar = (function (_super) {
            ...
            exports_1("_ViewerMobileToolbar", _ViewerMobileToolbar);
            _ViewerZoomBar = (function (_super) {
            ...
            exports_1("_ViewerZoomBar", _ViewerZoomBar);
            _SearchBar = (function (_super) {
            ...
            exports_1("_SearchBar", _SearchBar);
            'use strict';
            ...
            exports_1("_RotateAngle", _RotateAngle);
            _Page = (function () {
            ...
            exports_1("_Page", _Page);
            _CompositePageView = (function (_super) {
            ...
            exports_1("_CompositePageView", _CompositePageView);
            _PageViewBase = (function (_super) {
                ...
                _PageViewBase.prototype.moveToPosition = function (position) {
                    var _this = this;
                    var pageIndex = position.pageIndex || 0, promise;
                ...
                _PageViewBase.prototype._getTransformedPoint = function (top, left) {
                    top /= this.zoomFactor;
                    left /= this.zoomFactor;
                    var currentPage = this.pages[this.pageIndex], size = currentPage.size, rotateAngle = currentPage.rotateAngle;
                    switch (rotateAngle) {
                        case _RotateAngle.Rotation90:
                            var tmpTop = top;
                ...
                _PageViewBase.prototype._hitTestPagePosition = function (top, left) {
                    ...
                    var pageY = _pixelToTwip(top), pageX = _pixelToTwip(left), size = this.pages[this.pageIndex].size, hitPageView = top >= 0 && top <= size.height.valueInPixel &&
                ...
                _PageViewBase.prototype.hitTest = function (x, y) {
                    throw wjcCore.culture.Viewer.abstractMethodException;
                };
            ...
            _PageViewBase.controlTemplate = '<div class="wj-pages-wrapper" wj-part="pages-wrapper">' +
                '</div>';
            exports_1("_PageViewBase", _PageViewBase);
            _Scroller = (function (_super) {
            ...
            exports_1("_Scroller", _Scroller);
            _VScroller = (function (_super) {
            ...
            exports_1("_VScroller", _VScroller);
            _SinglePageView = (function (_super) {
                ...
                _SinglePageView.prototype.hitTest = function (x, y) {
            ...
            exports_1("_SinglePageView", _SinglePageView);
            _ContinuousPageView = (function (_super) {
                ...
                _ContinuousPageView.prototype._init = function () {
                    ...
                    _addEvent(this.hostElement, 'scroll', function () {
                        ...
                        scrollingTimer = setTimeout(function () {
                            var currentPageIndex = _this._guessPageIndex();
                            if (_this.pageIndex !== currentPageIndex) {
                                _this._render(currentPageIndex);
                                _this._updatePageIndex(currentPageIndex);
                            }
                            scrollingTimer = null;
                        }, 200);
                    });
                ...
                _ContinuousPageView.prototype._moveToPagePosition = function (position) {
                    this._stopSwip();
                    var pageHeight, scrollTop = 0, scrollLeft = 0, bound = position.pageBounds || { x: 0, y: 0, width: 0, height: 0 }, margin = position.pageBounds ? _PageViewBase._pageMargin : 0, currentPage = this.pages[this.pageIndex];
                ...
                _ContinuousPageView.prototype.hitTest = function (x, y) {
            ...
            exports_1("_ContinuousPageView", _ContinuousPageView);
            'use strict';
            _SideTabs = (function (_super) {
            ...
            exports_1("_TabPage", _TabPage);
            'use strict';
            _ViewerMenuBase = (function (_super) {
                ...
                function _ViewerMenuBase(viewer, owner, options) {
                    ...
                    _this._viewer._viewerActionStatusChanged.addHandler(function (s, e) {
                        var actionElement = _this.dropDown.querySelector('[' + _commandTagAttr + '="' + e.action.actionType.toString() + '"]');
                ...
                _ViewerMenuBase.prototype._updateItemsStatus = function () {
                    ...
                    for (var i = 0; i < elements.length; i++) {
                        var actionElement = elements[i], commandTagValue = actionElement.getAttribute(_commandTagAttr);
            ...
            exports_1("_ViewerMenuBase", _ViewerMenuBase);
            _HamburgerMenu = (function (_super) {
            ...
            exports_1("_HamburgerMenu", _HamburgerMenu);
            _ViewMenu = (function (_super) {
            ...
            exports_1("_ViewMenu", _ViewMenu);
            _SearchOptionsMenu = (function (_super) {
            ...
            exports_1("_SearchOptionsMenu", _SearchOptionsMenu);
            'use strict';
            (function (MouseMode) {
            ...
            exports_1("_LinkClickedEventArgs", _LinkClickedEventArgs);
            _HistoryManager = (function () {
            ...
            exports_1("_HistoryManager", _HistoryManager);
            ViewerBase = (function (_super) {
                ...
                ViewerBase.prototype._initTools = function () {
                    ...
                    this._rubberband.applied.addHandler(function () {
                        var bandRect = _this._rubberband.bandRect, hitTestInfo = _this._pageView.hitTest(bandRect.x, bandRect.y), containerRect = _this._viewpanelContainer.getBoundingClientRect();
                ...
                ViewerBase.prototype._initSidePanelSearch = function () {
                    var _this = this;
                    var sideTabs = wjcCore.Control.getControl(this._sidePanel), searchPage = sideTabs.addPage(wjcCore.culture.Viewer.search, icons.search);
                ...
                ViewerBase.prototype._initSidePanelOutlines = function () {
                    var _this = this;
                    var sideTabs = wjcCore.Control.getControl(this._sidePanel), outlinesPage = sideTabs.addPage(wjcCore.culture.Viewer.outlines, icons.outlines);
                ...
                ViewerBase.prototype._initSidePanelThumbnails = function () {
                    var _this = this;
                    var sideTabs = wjcCore.Control.getControl(this._sidePanel), thumbnailsPage = sideTabs.addPage(wjcCore.culture.Viewer.thumbnails, icons.thumbnails);
                    ...
                    thumbnailsPage.format(function (t) {
                        ...
                        var list = new wjcInput.ListBox(t.content), pngUrls = null, isItemsSourceSetting = false;
                        var svgStart = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml: space = "preserve" >';
                        list.formatItem.addHandler(function (sender, e) {
                            var item = e.item, data = e.data, svgContainer = document.createElement('div'), svg = _toDOM(svgStart + '</svg>'), g = document.createElementNS('http://www.w3.org/2000/svg', 'g'), img = document.createElementNS('http://www.w3.org/2000/svg', 'image'), indexDiv = document.createElement('div'), page = _this._pageView.pages[e.index], width = page.size.width.valueInPixel, height = page.size.height.valueInPixel, thumbnailHeight = height * ViewerBase._thumbnailWidth / width;
                            item.innerHTML = '';
                        ...
                        _this._pageView.rotateAngleChanged.addHandler(function () {
                            ...
                            for (var i = 0; i < svgs.length; i++) {
                                var page = _this._pageView.pages[i], current = svgs.item(i), thumbWidth = ViewerBase._thumbnailWidth, thumbHeight = page.size.height.valueInPixel * thumbWidth / page.size.width.valueInPixel;
                ...
                ViewerBase.prototype._initSidePanelExports = function () {
                    ...
                    exportsPage.format(function (t) {
                        ...
                        t.outContent.querySelector('.wj-tabtitle-wrapper').appendChild(settingsElement);
                        _this._gExportFormat = t.outContent.querySelector('.g-wj-exportformat');
                    ...
                    sideTabs.tabPageActived.addHandler(function () {
                        if (sideTabs.activedTabPage.id != _this._exportsPageId) {
                            return;
                        }
                        if (!_this._supportedFormats) {
                            _this._updateSupportedFormats().then(function () {
                                _this._updateExportFormats();
                            });
                        }
                        else {
                            _this._updateExportFormats();
                ...
                ViewerBase.prototype._updateExportFormats = function (refresh) {
                    var _this = this;
                    ...
                    var bindingItems = [];
                    this._supportedFormats.forEach(function (item) {
                ...
                ViewerBase.prototype._clearSupportedFormats = function () {
                    if (this._supportedFormats) {
                ...
                ViewerBase.prototype._updateSupportedFormats = function () {
                    var _this = this;
            ...
            ViewerBase.controlTemplate = '<div class="wj-viewer-outer wj-content with-footer">' +
                ...
                '</div>' +
                '</div>';
            exports_1("ViewerBase", ViewerBase);
            _PageSetupDialog = (function (_super) {
            ...
            _PageSetupDialog.controlTemplate = '<div>' +
                ...
                '</div>' +
                '</div>';
            exports_1("_PageSetupDialog", _PageSetupDialog);
            ...
            })(_ViewerActionType || (_ViewerActionType = {}));
            exports_1("_ViewerActionType", _ViewerActionType);
            _Rubberband = (function (_super) {
                ...
                function _Rubberband(element, viewPanelContainer, pageView) {
                    ...
                    _this._viewPanelContainer.appendChild(_this.hostElement);
                    wjcCore.addClass(_this.hostElement, _Rubberband._rubberbandCss);
                    _this._bindEvents();
                    return _this;
                }
                _Rubberband.prototype.onApplied = function () {
                    this.applied.raise(this);
                };
                Object.defineProperty(_Rubberband.prototype, "bandRect", {
                    get: function () {
                ...
                _Rubberband.prototype._bindEvents = function () {
                    var _this = this;
                ...
                _Rubberband.prototype.active = function () {
                    this._actived = true;
                    wjcCore.addClass(this._viewPanelContainer, _Rubberband._rubberbandActivedCss);
                };
                _Rubberband.prototype.deactive = function () {
                    if (!this._actived) {
                        return;
                    }
                    this._actived = false;
                ...
                _Rubberband.prototype._start = function (e) {
                    if (!this._actived) {
                        return;
                    }
                ...
                _Rubberband.prototype._stretching = function (e) {
                ...
                _Rubberband.prototype._stop = function () {
                    if (!this._actived) {
                        return;
                    }
                ...
                _Rubberband.prototype._zoom = function () {
                    ...
                    var bandRect = this.hostElement.getBoundingClientRect(), containerRect = this._viewPanelContainer.getBoundingClientRect();
                    if (bandRect.width > bandRect.height) {
            ...
            _Rubberband._rubberbandCss = 'wj-rubberband';
            _Rubberband._rubberbandActivedCss = 'rubberband-actived';
            _Rubberband._rubberbandShowCss = 'show';
            exports_1("_Rubberband", _Rubberband);
            _Magnifier = (function (_super) {
                ...
                _Magnifier.prototype._initElement = function () {
                    wjcCore.addClass(this.hostElement, 'wj-magnifier');
                    this._viewPageDiv = _toDOM(_Magnifier._viewPageTemplate);
                ...
                _Magnifier.prototype._bindEvents = function () {
                    ...
                    this.addEventListener(this._viewPanelContainer, 'mousedown', function (e) {
                        _this._show(e, true);
                        _this.addEventListener(_this._viewPanelContainer, 'mousemove', function (e) {
                            _this._show(e, false);
                        });
                        _this.addEventListener(document, 'mouseup', function (e) {
                            _this._hide();
                        });
                    });
                    var updateViewPage = function () {
                        ...
                        var currentPage = _this._pageView.pages[_this._currentPageIndex], rotatedSize = _getRotatedSize(currentPage.size, currentPage.rotateAngle), svg = _this._viewPageDiv.querySelector('svg');
                        _this._viewPageDiv.style.height = rotatedSize.height.valueInPixel * _this._pageView.zoomFactor * _Magnifier._magnification + 'px';
                        _this._viewPageDiv.style.width = rotatedSize.width.valueInPixel * _this._pageView.zoomFactor * _Magnifier._magnification + 'px';
                        svg.setAttribute('width', _this._viewPageDiv.style.width);
                        svg.setAttribute('height', _this._viewPageDiv.style.height);
                        _transformSvg(svg, currentPage.size.width.valueInPixel, currentPage.size.height.valueInPixel, _Magnifier._magnification * _this._pageView.zoomFactor, currentPage.rotateAngle);
                    };
                    this._pageView.zoomFactorChanged.addHandler(function () {
                        updateViewPage();
                    });
                    this._pageView.rotateAngleChanged.addHandler(function () {
                        updateViewPage();
                    });
                };
                _Magnifier.prototype._fillPage = function (hitPosition) {
                    ...
                    this._pageView.pages[this._currentPageIndex].getContent().then(function (pageContent) {
                        ...
                        var size = _this._pageView.pages[_this._currentPageIndex].size;
                        _transformSvg(clone, size.width.valueInPixel, size.height.valueInPixel, _Magnifier._magnification * _this._pageView.zoomFactor, _this._pageView.pages[_this._currentPageIndex].rotateAngle);
                ...
                _Magnifier.prototype._showHitPosition = function (hitPosition) {
                    var magnifierRect = this.hostElement.getBoundingClientRect(), currentPage = this._pageView.pages[this._currentPageIndex], transformedBound = _getTransformedPosition(hitPosition.pageBounds, currentPage.size, currentPage.rotateAngle, this._pageView.zoomFactor);
                ...
                _Magnifier.prototype._show = function (e, start) {
                    if (!this._actived) {
                        return;
                    }
                    var clientRect = this._viewPanelContainer.getBoundingClientRect();
                    ...
                    var hitTestInfo = this._pageView.hitTest(x, y), position = _getPositionByHitTestInfo(hitTestInfo);
            ...
            _Magnifier._magnification = 2;
            _Magnifier._magnifierActivedCss = 'magnifier-actived';
            _Magnifier._magnifierShowCss = 'show';
            _Magnifier._viewPageTemplate = '<div class="wj-view-page"></div>';
            exports_1("_Magnifier", _Magnifier);
            'use strict';
            parametersIcon = '<path d="M24,11.9v-2h-4V7h0V5h0h-1h-5V2h0V0h0h-1H1H0h0v2h0v11h0v1h0h1h5v4h0v1h0h1h3v4h0v1h0h1h2.1v-1H11V12h2.1v-2H11h-1h0v2h0v6H7V7h12v2.9h-1v2h5V23h-4.9v1H23h1h0v-1h0L24,11.9L24,11.9z M6,5L6,5l0,2h0v6H1V2h12v3H7H6z"/>' +
            ...
            exports_1("ReportViewer", ReportViewer);
            _ParametersEditor = (function (_super) {
            ...
            exports_1("_ParametersEditor", _ParametersEditor);
            _MultiSelectEx = (function () {
            ...
            exports_1("_MultiSelectEx", _MultiSelectEx);
            _ReportHamburgerMenu = (function (_super) {
            ...
            exports_1("_ReportHamburgerMenu", _ReportHamburgerMenu);
            'use strict';
            PdfViewer = (function (_super) {
