System.register(["wijmo/wijmo", "wijmo/wijmo.odata"], function (exports_1, context_1) {
    "use strict";
    ...
    var wjcCore, wjcSelf, ODataCollectionView, ODataVirtualCollectionView;
    return {
        setters: [
            function (wjcCore_1) {
                wjcCore = wjcCore_1;
        ...
        execute: function () {
            ...
            'use strict';
            ODataCollectionView = (function (_super) {
                ...
                ODataCollectionView.prototype._convertItem = function (dataTypes, item) {
                    for (var k in dataTypes) {
                        ...
                        if (value != undefined) {
                            if (type === wjcCore.DataType.Date && value && value.indexOf('/Date(') == 0) {
            ...
            exports_1("ODataCollectionView", ODataCollectionView);
            'use strict';
            ODataVirtualCollectionView = (function (_super) {
            ...
            exports_1("ODataVirtualCollectionView", ODataVirtualCollectionView);
        }
    };
});
