...
define(["require", "exports", "wijmo/wijmo.chart", "wijmo/wijmo", "wijmo/wijmo.chart.hierarchical"], function (require, exports, wjcChart, wjcCore, wjcSelf) {
    "use strict";
    ...
    var TreeMap = (function (_super) {
        ...
        TreeMap.prototype._render = function (engine) {
            var el = this.hostElement, sz = this._getHostSize(), w = sz.width, h = sz.height, items, maxDepth, sum;
            if (w == 0 || isNaN(w)) {
        ...
        TreeMap.prototype._renderLabels = function (engine) {
            var len = this._areas.length, lbl = this.dataLabel, pos = lbl.position, line = lbl.connectingLine, bdr = lbl.border, marg = 2, gcss = 'wj-data-labels', pt;
