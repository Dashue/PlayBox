...
/*
    ...
    */
    ...
    export class ValueFilterEditor extends wjcCore.Control {
        ...
        constructor(element: any, filter: ValueFilter) {
            ...
            if (filter.sortValues) { // TFS 190560
                var sortBinding = filter.column.dataMap || filter.dataMap ? 'text' : 'value',
    ...
    export class ColumnFilterEditor extends wjcCore.Control {
         ...
         */
        buttonClicked = new wjcCore.Event();
        /**
 ...
 */
    ...
    export class FlexGridFilter {
        ...
        set filterDefinition(value: string) {
            ...
            this.clear(); // empty/null clears filter
            if (value) { // parse and apply value
        ...
        editColumnFilter(col: any, ht?: wjcGrid.HitTestInfo) {
            ...
            edt.buttonClicked.addHandler(() => {
                //this.closeEditor();
                this._g.focus(); // return focus to grid (will close editor)
         ...
         * });</pre>
         */
        filterChanging = new wjcCore.Event();
        /**
        ...
        _mouseDown(e: MouseEvent) {
            if (!e.defaultPrevented &&
                e.button == 0 && // start actions on left button only: TFS 114623
                !e['dataTransfer']) { // ignore when touch-dragging
