Npm image for Wijmo CommonJS modules (sources)
==============================================

This folder represents an npm image containing Wijmo core and Angular 2 interop 
modules in CommonJS module format (non-minified), and corresponding TypeScript source  
...
npm install ../wijmo_download/NpmImages/wijmo-commonjs-src
...
"dependencies": {
   "wijmo": "../wijmo_download/NpmImages/wijmo-commonjs-src",
   … other libraries
}
