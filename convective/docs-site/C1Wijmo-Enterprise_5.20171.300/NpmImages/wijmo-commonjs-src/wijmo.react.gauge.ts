...
import * as wjcSelf from 'wijmo/wijmo.react.gauge';
 ...
 */
     ...
     * current value. 
     */
    export class LinearGauge extends wjcReactBase.ComponentBase {
        constructor(props) {
            super(props, wjcGauge.LinearGauge);
        } 
    }
     ...
     * current value. 
     */
    export class BulletGraph extends wjcReactBase.ComponentBase {
        constructor(props) {
            super(props, wjcGauge.BulletGraph);
        } 
    }
     ...
     * current value. 
     */
    export class RadialGauge extends wjcReactBase.ComponentBase {
        constructor(props) {
            super(props, wjcGauge.RadialGauge);
        } 
    }
