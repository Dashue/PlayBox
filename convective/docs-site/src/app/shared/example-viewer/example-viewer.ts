...
import {EXAMPLE_COMPONENTS, LiveExample} from '../../material-examples/example-module';
import {HFC_EXAMPLE_COMPONENTS} from '../../hfc-examples/example-module';
...
export class ExampleViewer {
  ...
  set example(example: string) {
    if (example && EXAMPLE_COMPONENTS[example]) {
      ...
      this._example = example;
      this.exampleData = HFC_EXAMPLE_COMPONENTS[example];
      this.selectedPortal = new ComponentPortal(this.exampleData.component);
      return;
    } else {
