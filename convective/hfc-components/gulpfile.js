...
const releaseFolder = path.join(rootFolder, '../hfc-releases/hfc-components/dist');
...
gulp.task('clean:dist', function () {
  ...
  return deleteFolders([distFolder + '/**', '!' + distFolder,  releaseFolder + '/**', '!' + distFolder]);
});
...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    ...
    .pipe(rename('hfc-components.umd.js'))
    .pipe(gulp.dest(distFolder));
});
...
/**
 * 12. Copy /dist into release folder
 */
  ...
  runSequence(
    ...
    function (err) {
      if (err) {
        ...
        deleteFolders([releaseFolder, distFolder, tmpFolder, buildFolder]);
      } else {
