...
wijmo.DateTime.newDate = function(year, month, day, hour, min, sec, ms) {
/// <summary>Gets a new Date object instance.</summary>
/// <param name="year" type="Number" optional="true">Integer value representing the year, defaults to current year.</param>
/// <param name="month" type="Number" optional="true">Integer value representing the month (0-11), defaults to current month.</param>
/// <param name="day" type="Number" optional="true">Integer value representing the day (1-31), defaults to current day.</param>
/// <param name="hour" type="Number" optional="true">Integer value representing the hour, defaults to zero.</param>
/// <param name="min" type="Number" optional="true">Integer value representing the minute, defaults to zero.</param>
/// <param name="sec" type="Number" optional="true">Integer value representing the second, defaults to zero.</param>
/// <param name="ms" type="Number" optional="true">Integer value representing the millisecond, defaults to zero.</param>
/// <returns type="Date"></returns>
}
...
/// <field name="isVisible" type="Boolean">Gets a value that determines whether the tooltip is currently visible.</field>
...
wijmo.Tooltip.prototype.getTooltip = function(element) {
/// <summary>Gets the tooltip content associated with a given element.</summary>
/// <param name="element" type="Object" optional="false">Element, element ID, or control that the tooltip explains.</param>
/// <returns type="String">Tooltip content associated with the given element.</returns>
}
...
/// the @see:CollectionView.getError property on the grid's @see:itemsSource.</field>
/// <field name="itemValidator" type="Function">Gets or sets a validator function to determine whether cells contain
/// valid data.
/// 
...
/// <field name="editableCollectionView" type="wijmo.collections.IEditableCollectionView">Gets the @see:IEditableCollectionView that contains the grid data.</field>
...
/// <field name="rowHeaderPath" type="String">Gets or sets the name of the property used to create row header
/// cells.
/// 
/// Row header cells are not visible or selectable. They are meant
/// for use with accessibility tools.</field>
...
/// may be selected and edited.</field>
/// <field name="cloneFrozenCells" type="Boolean">Gets or sets a value that determines whether the FlexGrid should
...
/// to select the best setting depending on the browser.</field>
...
/// <field name="keyActionTab" type="wijmo.grid.KeyAction">Gets or sets the action to perform when the TAB key is pressed.
/// 
...
/// for accessibility.</field>
/// <field name="keyActionEnter" type="wijmo.grid.KeyAction">Gets or sets the action to perform when the ENTER key is pressed.
/// 
...
/// This is the standard Excel behavior.</field>
...
wijmo.grid.GridPanel = function(g, cellType, rows, cols, host) {
...
/// <param name="host" type="HTMLElement" optional="false">The HTMLElement that hosts the cells in the control.</param>
...
/// <field name="visibleIndex" type="Number">Gets the index of the row or column in the parent collection
/// ignoring invisible elements (@see:isVisible).</field>
...
wijmo.grid.RowCol._wjDict = _wjMerge({}, {visible:2,isVisible:2,pos:2,index:2,visibleIndex:2,size:2,renderSize:2,allowResizing:2,allowDragging:2,allowMerging:2,isSelected:2,isReadOnly:2,isContentHtml:2,wordWrap:2,cssClass:2,grid:2,collectionView:2});
...
/// <field name="showDropDown" type="Boolean">Gets or sets a value that indicates whether the grid adds drop-down
...
/// <field name="visibleLength" type="Number">Gets the number of visible elements in the collection (@see:Row.isVisible).</field>
...
wijmo.grid.RowColCollection._wjDict = _wjMerge(wijmo.collections.ObservableArray._wjDict, {defaultSize:2,frozen:2,minSize:2,maxSize:2,visibleLength:2});
...
/// <param name="grid" type="Object" optional="false">The @see:FlexGrid control, @see:GridPanel, or cell element
/// to investigate.</param>
...
/// <field name="cellType" type="wijmo.grid.CellType">Gets the type of cell found at the specified position.</field>
/// <field name="panel" type="wijmo.grid.GridPanel">Gets the @see:GridPanel that this @see:HitTestInfo refers to.</field>
/// <field name="grid" type="wijmo.grid.FlexGrid">Gets the @see:FlexGrid that this @see:HitTestInfo refers to.</field>
...
wijmo.grid.HitTestInfo._wjDict = _wjMerge({}, {point:2,cellType:2,panel:2,grid:2,row:2,col:2,range:2,edgeLeft:2,edgeTop:2,edgeRight:2,edgeBottom:2});
...
wijmo.grid._EditHandler.prototype.getClipString = function(rng) {
/// <summary>Gets the content of a @see:CellRange as a string suitable for
/// copying to the clipboard.
/// 
/// Hidden rows and columns are not included in the clip string.</summary>
...
wijmo.grid._EditHandler.prototype.setClipString = function(text, rng) {
/// <summary>Parses a string into rows and columns and applies the content to a given range.
/// 
/// Hidden rows and columns are skipped.</summary>
/// <param name="text" type="String" optional="false">Tab and newline delimited text to parse into the grid.</param>
...
/// <field name="showValues" type="Object">Gets or sets an object with all the formatted values that should be
/// shown on the value list.</field>
...
/// <field name="isAnimated" type="Boolean">Gets or sets a value that indicates whether the control should use a fade-in
/// animation when displaying the drop-down.</field>
...
/// <field name="formatYearMonth" type="String">Gets or sets the format used to display the month and year
/// above the calendar in month view.
/// 
/// The default value for this property is 'y'.</field>
/// <field name="formatDayHeaders" type="String">Gets or sets the format used to display the headers
/// above the days in month view.
/// 
/// The default value for this property is 'ddd'.</field>
/// <field name="formatDays" type="String">Gets or sets the format used to display the days
/// in month view.
/// 
...
/// used to represent the short date pattern).</field>
/// <field name="formatYear" type="String">Gets or sets the format used to display the year
/// above the months in year view.
/// 
/// The default value for this property is 'yyyy'.</field>
/// <field name="formatMonths" type="String">Gets or sets the format used to display the months
/// in year view.
/// 
/// The default value for this property is 'MMM'.</field>
...
wijmo.input.Calendar._wjDict = _wjMerge(wijmo.Control._wjDict, {value:2,min:2,max:2,selectionMode:2,isReadOnly:2,firstDayOfWeek:2,displayMonth:2,formatYearMonth:2,formatDayHeaders:2,formatDays:2,formatYear:2,formatMonths:2,showHeader:2,monthView:2,itemFormatter:2,itemValidator:2,valueChanged:1,displayMonthChanged:1,formatItem:1});
...
/// <field name="definedNames" type="wijmo.xlsx.DefinedName[]">Gets the defined name items of the workbook.</field>
...
wijmo.xlsx.Workbook._wjDict = _wjMerge({}, {sheets:2,styles:2,definedNames:2,reservedContent:2});
...
wijmo.xlsx.DefinedName = function() {
/// <summary>Initializes a new instance of the @see:DefinedName class.</summary>
/// <returns type="wijmo.xlsx.DefinedName"></returns>
/// <field name="name" type="String">The name of the defined name item.</field>
/// <field name="value" type="Object">The value of the defined name item.
/// The value could be a formula, a string constant or a cell range.
/// For e.g. "Sum(1, 2, 3)", "test" or "sheet1!A1:B2"</field>
/// <field name="sheetName" type="String">Indicates the defined name item works in which sheet.
/// If omitted, the defined name item works in workbook</field>
this._wjClassName = 'wijmo.xlsx.DefinedName';
_wjReownEvents(this);
}
wijmo.xlsx.DefinedName._wjDict = _wjMerge({}, {});
wijmo.xlsx.DefinedName._wjClass = true;
wijmo.xlsx.HAlign = {
...
wijmo.nav.TreeView.prototype.loadTree = function() {
/// <summary>Loads the tree using data from the current @see:itemsSource.</summary>
}
...
this.nameChanged = new wijmo.Event('wijmo.PropertyChangedEventArgs');
...
/// <param name="e" type="wijmo.PropertyChangedEventArgs" optional="false"></param>
}
...
wijmo.olap.PivotField._wjDict = _wjMerge({}, {binding:2,header:2,filter:2,aggregate:2,showAs:2,weightField:2,dataType:2,format:2,width:2,wordWrap:2,descending:2,isContentHtml:2,sortComparer:2,engine:2,collectionView:2,isActive:2,parentField:2,key:2,propertyChanged:1});
