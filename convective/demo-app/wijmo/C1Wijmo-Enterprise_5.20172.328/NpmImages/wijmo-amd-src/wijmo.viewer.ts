...
wjcCore.culture.Viewer = window['wijmo'].culture.Viewer || {
    ...
    export class _SearchManager {
        ...
        private _getSearchResults() {
            ...
            return this.documentSource.search({ text: encodeURIComponent(this.text), matchCase: this.matchCase, wholeWord: this.wholeWord }).then(v => {
    ...
    export class _ContinuousPageView extends _PageViewBase {
        ...
        protected _panelViewPntToPageView(clientX: number, clientY: number): _IPageHitTestInfo {
            ...
            var viewPage = <HTMLElement>this._pagesWrapper.querySelectorAll('.wj-view-page').item(hitPageIndex);
            if (viewPage) {
...
*/
    ...
    */
    ...
    export class _MouseTool extends wjcCore.Control {
        private _pageView: _IPageView;
        private _viewPanelContainer: HTMLElement;
        private _isActive: boolean;
        private _isStarted: boolean;
        private _startPnt: wjcCore.Point;
        ...
        protected _innerStop(pnt?: wjcCore.Point) {
            try {
                this._stop(pnt);
            } finally {
        ...
        protected _move(pnt: wjcCore.Point, ht: _IHitTestInfo) {
        }

        protected _stop(pnt?: wjcCore.Point) {
    ...
    export class _RubberbandOnAppliedEventArgs extends wjcCore.EventArgs {
    ...
    export class _Magnifier extends _MouseTool {
        ...
        private _showMagnifer(pnt: wjcCore.Point, ht: _IHitTestInfo) {
