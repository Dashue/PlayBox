...
define(["require", "exports", "wijmo/wijmo.grid", "wijmo/wijmo", "wijmo/wijmo.grid.multirow"], function (require, exports, wjcGrid, wjcCore, wjcSelf) {
    "use strict";
        ...
        _MergeManager.prototype.getMergedRange = function (p, r, c, clip) {
            ...
            switch (p.cellType) {
                ...
                case wjcGrid.CellType.ColumnHeader:
                    ...
                    return rng;
                case wjcGrid.CellType.RowHeader:
                    var rpi = grid._rowsPerItem, row = p.rows[r], top_1 = r - row.recordIndex;
                    return new wjcGrid.CellRange(top_1, 0, top_1 + rpi - 1, p.columns.length - 1);
