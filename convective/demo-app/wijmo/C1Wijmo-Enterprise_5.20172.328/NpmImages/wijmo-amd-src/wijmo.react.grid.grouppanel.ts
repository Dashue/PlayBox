...
import * as wjcSelf from 'wijmo/wijmo.react.grid.grouppanel';
 ...
 */
     ...
     */
    export class GroupPanel extends wjcReactBase.ComponentBase {
        constructor(props) {
            super(props, wjcGridGrouppanel.GroupPanel);
        } 
    }
