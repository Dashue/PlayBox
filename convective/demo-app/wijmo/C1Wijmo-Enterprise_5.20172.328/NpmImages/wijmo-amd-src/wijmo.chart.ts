    ...
    */
        ...
        */
        ...
        _toControl(pt: any, y?: number): wjcCore.Point {
            if (wjcCore.isNumber(pt) && wjcCore.isNumber(y)) { // accept hitTest(x, y) as well
                ...
                pt = wjcCore.mouseToPage(pt);// new Point(pt.pageX, pt.pageY);
            }
    ...
    export class FlexChartCore extends FlexChartBase {
        ...
        */
        ...
        private _renderLegendElements(engine: IRenderEngine, series: SeriesBase, pos: wjcCore.Point, p: wjcCore.Point, areas: any[], isVertical: boolean, width: number, height: number, colRowLen: number) {
