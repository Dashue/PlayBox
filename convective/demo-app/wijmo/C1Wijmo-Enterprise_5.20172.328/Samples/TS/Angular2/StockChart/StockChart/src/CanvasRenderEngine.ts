...
import * as wjcSelf from './CanvasRenderEngine';
window['CanvasRenderEngine'] = wjcSelf;
     ...
     * Render to canvas.
     */
    export class _CanvasRenderEngine implements wjcChart.IRenderEngine {
        private _element: HTMLElement;
        private _canvas: HTMLCanvasElement;
        private _svgEngine: wjcChart._SvgRenderEngine;
        // 
        ...
        drawSplines(xs: number[], ys: number[], className?: string, style?: any, clipPath?: string) {
            ...
            var ctx = this._canvas.getContext('2d'),
                spline = new wjcChart._Spline(xs, ys),
                s = spline.calculate(),
                sx = s.xs,
                sy = s.ys,
    ...
    if (wjcChart.FlexChartBase && wjcChart.FlexChartBase.prototype && wjcChart.FlexChartBase.prototype._exportToImage) {
        ...
        wjcChart.FlexChartBase.prototype._exportToImage = function (extension, processDataURI) {
            ...
            var canvasEngine = new _CanvasRenderEngine(this.hostElement, true),
                r = this.rendered,
                dataUrl, canvas;
