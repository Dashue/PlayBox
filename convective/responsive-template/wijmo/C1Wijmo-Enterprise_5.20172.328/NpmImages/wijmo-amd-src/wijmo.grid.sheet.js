...
define(["require", "exports", "wijmo/wijmo", "wijmo/wijmo.xlsx", "wijmo/wijmo.grid", "wijmo/wijmo.input", "wijmo/wijmo.grid.filter", "wijmo/wijmo.grid.xlsx", "wijmo/wijmo.grid.sheet"], function (require, exports, wjcCore, wjcXlsx, wjcGrid, wjcInput, wjcGridFilter, wjcGridXlsx, wjcSelf) {
    ...
    var _CalcEngine = (function () {
        ...
        _CalcEngine.prototype._parseAtom = function () {
            var x = null, id, funcDefinition, params, pCnt, cellRef, definedName, orgExpression, orgExpressionLength, orgPointer, definedNameRefs, definedNameRef, sheetRef;
        ...
        _CalcEngine.prototype._getDefinedName = function (name) {
            var item;
    ...
    var FlexSheet = (function (_super) {
        ...
        function FlexSheet(element, options) {
            ...
            _this.definedNames = new wjcCore.ObservableArray();
        ...
        FlexSheet.prototype._loadFromWorkbook = function (workbook) {
            var sheetCount, defiendName, sheetIndex = 0, self = this;
        ...
        FlexSheet.prototype._saveToWorkbook = function () {
            var mainBook, tmpBook, definedName, item, currentSheet, sheetIndex;
            if (this.sheets.length === 0) {
        ...
        FlexSheet.prototype._delSeletionContent = function (evt) {
            var selections = this.selectedSheet.selectionRanges, selection, evtRange, index, colIndex, rowIndex, bcol, contentDeleted = false, e, delAction = new _EditAction(this);
            if (this.isReadOnly) {
                return;
            }
            this.beginUpdate();
    ...
    var FlexSheetPanel = (function (_super) {
        ...
        FlexSheetPanel.prototype._renderCell = function (row, r, c, vrng, state, ctr) {
            var cell = row.childNodes[ctr], cellStyle, cellIndex = r * this.grid.columns.length + c, mr = this.grid.getMergedRange(this, r, c);
            ctr = _super.prototype._renderCell.call(this, row, r, c, vrng, state, ctr);
            if (this.cellType !== wjcGrid.CellType.Cell) {
                return ctr;
            }
            if (mr) {
