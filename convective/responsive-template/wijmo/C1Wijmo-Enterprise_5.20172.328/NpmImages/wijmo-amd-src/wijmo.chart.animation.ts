...
import * as wjcSelf from 'wijmo/wijmo.chart.animation';
 ...
 */
    ...
    export class ChartAnimation {
        private _chart: wjcChart.FlexChartBase;
        private _animation: FlexAnimation;
        private _cv: wjcCore.ICollectionView;
        private _updateEventArgs: Array<wjcCore.NotifyCollectionChangedEventArgs>;
        private _chartType;
        private _play = true;
        ...
        constructor(chart: wjcChart.FlexChartBase, options?: any) {
            var self = this,
                ...
                sz = new wjcCore.Size(ele.offsetWidth, ele.offsetHeight);

            self._chart = chart;
            self._updateEventArgs = [];
            if (chart instanceof wjcChart.FlexPie) {
                self._animation = new FlexPieAnimation(<wjcChart.FlexPie>chart, self._updateEventArgs);
            } else {
                if ((tryGetModuleWijmoChartRadar()) && (tryGetModuleWijmoChartRadar()).FlexRadar && chart instanceof (tryGetModuleWijmoChartRadar()).FlexRadar) {
                    ...
                    self._animation = new FlexChartAnimation(<wjcChart.FlexChartCore>chart, self._updateEventArgs);
                }
    ...
    class FlexAnimation {
        ...
        constructor(chart: wjcChart.FlexChartBase, updateEventArgs) {
            this._chart = chart;
            this._timers = [];
        }
    ...
    class FlexPieAnimation extends FlexAnimation {
        _chart: wjcChart.FlexPie;
        _isSelectionChanged: boolean;

        constructor(chart: wjcChart.FlexPie, updateEventArgs) {
    ...
    class FlexChartAnimation extends FlexAnimation {
        ...
        constructor(chart: wjcChart.FlexChartCore, updateEventArgs) {
            super(chart, updateEventArgs);
        }
        ...
        playAnimation() {
            ...
            var self = this,
                isLoad = true,
                chart = self._chart,
                isFinancial = (tryGetModuleWijmoChartFinance()) && (tryGetModuleWijmoChartFinance()).FinancialChart &&
                    chart instanceof (tryGetModuleWijmoChartFinance()).FinancialChart,
                series = chart.series,
                len = series.length,
                i, s: wjcChart.SeriesBase, chartType: string, seriesType: wjcChart.ChartType, prevLen: number,
        ...
        _playAxesAnimation() {
            var self = this,
                ...
                len = axes.length,
                axis: wjcChart.Axis, i: number, maxLen: number;
        ...
        _convertAxisAnimation(animations, state, axis: wjcChart.Axis, maxValue?, minValue?) {
            var host = axis.hostElement, animation,
                isVert = axis.axisType == wjcChart.AxisType.Y;
        ...
        _parseAxisState(axisState) {
            ...
            var vals = axisState.vals,
                axis: wjcChart.Axis = axisState.axis,
                isVert = axis.axisType == wjcChart.AxisType.Y,
                ele = axisState.ele,
                eles = ele.childNodes,
                eleIdx = 0,
        ...
        _playUpdateAnimation(animations: Array<any>, i: number, chartType: string, series: wjcChart.SeriesBase, prevState) {
        ...
        _getChartType(chartType: wjcChart.ChartType) {
            var cType = 'Default',
        ...
        _playLineMoveAnimation(animations: Array<any>, series: wjcChart.SeriesBase, prevState) {
            var self = this,
                chart = self._chart,
                animation = self._getAnimation(animations, 0),
                symbols = [],
        ...
        _playColumnMoveAnimation(animations: Array<any>, series: wjcChart.SeriesBase, prevState) {
        ...
        _playBarMoveAnimation(animations: Array<any>, series: wjcChart.SeriesBase, prevState, vertical = false) {
            var self = this,
                chart = self._chart,
        ...
        _playScatterMoveAnimation(animations: Array<any>, series: wjcChart.SeriesBase, prevState) {
            var self = this,
                chart = self._chart,
                animation = self._getAnimation(animations, 0),
                ele, eles, parNode, prevEles, prevEle, prevLen, len, idx;
    ...
    class FlexRadarAnimation extends FlexChartAnimation {
        ...
        constructor(chart: wjcChartRadar.FlexRadar, updateEventArgs) {
            super(chart, updateEventArgs);
        }
