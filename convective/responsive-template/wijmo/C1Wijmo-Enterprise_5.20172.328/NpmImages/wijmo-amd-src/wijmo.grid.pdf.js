...
define(["require", "exports", "wijmo/wijmo.pdf", "wijmo/wijmo.grid", "wijmo/wijmo", "wijmo/wijmo.grid.pdf"], function (require, exports, wjcPdf, wjcGrid, wjcCore, wjcSelf) {
    "use strict";
    ...
    var PivotGridRenderer = (function (_super) {
        ...
        function PivotGridRenderer(pivot, range, repeatMergedValues, borderWidth, styles, lastPage) {
            return _super.call(this, pivot, range, repeatMergedValues, borderWidth, styles, lastPage) || this;
        }
    ...
    var PanelSectionRenderer = (function (_super) {
        ...
        PanelSectionRenderer.prototype.render = function (doc, x, y, settings) {
            var _this = this;
            var ranges = this.range, pnl = this.panel, mngr = new GetMergedRangeProxy(this._gr.flex), curCellRange = new CellRangeExt(pnl, 0, 0, 0, 0), cellRenderer = new CellRenderer(this, doc, settings, this._borderWidth);
            if (!ranges.isValid) {
                return;
            }
            var pY = {};
