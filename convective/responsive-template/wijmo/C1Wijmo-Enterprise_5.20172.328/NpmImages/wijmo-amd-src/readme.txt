Npm image for Wijmo AMD modules (sources)
=========================================

This folder represents an npm image containing Wijmo core and Angular 2 interop 
modules in AMD module format (non-minified), and corresponding TypeScript source  
...
npm install ../wijmo_download/NpmImages/wijmo-amd-src
...
"dependencies": {
   "wijmo": "../wijmo_download/NpmImages/wijmo-amd-src",
   … other libraries
}
