...
export var wjFlexChartAnimationMeta: IWjComponentMeta = {
...
@Component({
	...
	providers: [
        { provide: 'WjComponent', useExisting: forwardRef(() => WjFlexChartAnimation)},
        ...wjFlexChartAnimationMeta.providers
    ]
})
export class WjFlexChartAnimation extends wjcChartAnimation.ChartAnimation implements OnInit, OnDestroy, AfterViewInit {
...
export class WjChartAnimationModule {
}
